...
class EvaluatorTest(unittest.TestCase):
    ...
    def test_must_equal_seq_vs_seq_using_zip_sequence(self):
        self.assertEqual(evaluate(DummyNode(), '(5,6,7) zip sequence = (5,5)'), [True, False])
        self.assertEqual(evaluate(DummyNode(), '(5,5) zip sequence = (5,6,7)'), [True, False])
        self.assertEqual(evaluate(DummyNode(), '(5.0,"6",7) zip sequence = (5,5)'), [True, False])
        ...
        self.assertEqual(evaluate(DummyNode(), '(x,6) zip sequence = (5,5)'), [False, False])
    ...
    def test_must_equal_seq_vs_seq_using_zip_any(self):
        ...
        self.assertEqual(evaluate(DummyNode(), '(x,6) zip any = (5,5)'), False)
    ...
    def test_must_equal_seq_vs_seq_using_zip_all(self):
        ...
        self.assertEqual(evaluate(DummyNode(), '(5,5) zip all = (5,5)'), True)
    ...
    def test_must_equal_seq_vs_seq_using_product_sequence(self):
        self.assertEqual(evaluate(DummyNode(), '(5,6) product sequence = (5,5)'), [True, True, False, False])
        self.assertEqual(evaluate(DummyNode(), '(5,6) product sequence = (5.0,"6")'), [True, False, False, True])
        self.assertEqual(evaluate(DummyNode(), '(5.0,"6") product sequence = (5,6)'), [True, False, False, True])
    ...
    def test_must_equal_seq_vs_seq_using_product_any(self):
        ...
        self.assertEqual(evaluate(DummyNode(), '(5,6) product any = (x,x)'), False)
    ...
    def test_must_equal_seq_vs_seq_using_product_all(self):
        ...
        self.assertEqual(evaluate(DummyNode(), '(5,5) product all = (5,5)'), True)
    ...
    def test_must_equal_seq_vs_seq(self): # defualts to using "product any"
        ...
        self.assertEqual(evaluate(DummyNode(), '(5,6) = (x,x)'), False)
        self.assertEqual(evaluate(DummyNode(), '(5,6) = ()'), False)
