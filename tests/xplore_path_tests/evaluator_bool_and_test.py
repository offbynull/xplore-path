...
class EvaluatorTest(unittest.TestCase):
    ...
    def test_must_apply_and_single_vs_seq_using_zip_sequence(self):
        # lhs coerces to true
        self.assertEqual(evaluate(DummyPath(), 'true zip sequence and (true, true)'), [True])
        self.assertEqual(evaluate(DummyPath(), 'true zip sequence and (true, false)'), [True])
        self.assertEqual(evaluate(DummyPath(), 'true zip sequence and (1, nan, "s", "")'), [True])
        self.assertEqual(evaluate(DummyPath(), 'true zip sequence and (1, "s", true)'), [True])
        self.assertEqual(evaluate(DummyPath(), 'true zip sequence and (0, nan, "")'), [False])
        self.assertEqual(evaluate(DummyPath(), '"a" zip sequence and (true, true)'), [True])
        self.assertEqual(evaluate(DummyPath(), '"a" zip sequence and (true, false)'), [True])
        self.assertEqual(evaluate(DummyPath(), '"a" zip sequence and (1, nan, "s", "")'), [True])
        self.assertEqual(evaluate(DummyPath(), '"a" zip sequence and (1, "s", true)'), [True])
        self.assertEqual(evaluate(DummyPath(), '"a" zip sequence and (0, nan, "")'), [False])
        self.assertEqual(evaluate(DummyPath(), '1 zip sequence and (true, true)'), [True])
        self.assertEqual(evaluate(DummyPath(), '1 zip sequence and (true, false)'), [True])
        self.assertEqual(evaluate(DummyPath(), '1 zip sequence and (1, nan, "s", "")'), [True])
        self.assertEqual(evaluate(DummyPath(), '1 zip sequence and (1, "s", true)'), [True])
        self.assertEqual(evaluate(DummyPath(), '1 zip sequence and (0, nan, "")'), [False])
        self.assertEqual(evaluate(DummyPath(), '1.5 zip sequence and (true, true)'), [True])
        self.assertEqual(evaluate(DummyPath(), '1.5 zip sequence and (true, false)'), [True])
        self.assertEqual(evaluate(DummyPath(), '1.5 zip sequence and (1, nan, "s", "")'), [True])
        self.assertEqual(evaluate(DummyPath(), '1.5 zip sequence and (1, "s", true)'), [True])
        self.assertEqual(evaluate(DummyPath(), '1.5 zip sequence and (0, nan, "")'), [False])
        # lhs coerces to false
        self.assertEqual(evaluate(DummyPath(), 'false zip sequence and (true, true)'), [False])
        self.assertEqual(evaluate(DummyPath(), 'false zip sequence and (true, false)'), [False])
        self.assertEqual(evaluate(DummyPath(), 'false zip sequence and (1, nan, "s", "")'), [False])
        self.assertEqual(evaluate(DummyPath(), 'false zip sequence and (1, "s", False)'), [False])
        self.assertEqual(evaluate(DummyPath(), 'false zip sequence and (0, nan, "")'), [False])
        self.assertEqual(evaluate(DummyPath(), '"" zip sequence and (true, true)'), [False])
        self.assertEqual(evaluate(DummyPath(), '"" zip sequence and (true, false)'), [False])
        self.assertEqual(evaluate(DummyPath(), '"" zip sequence and (1, nan, "s", "")'), [False])
        self.assertEqual(evaluate(DummyPath(), '"" zip sequence and (1, "s", False)'), [False])
        self.assertEqual(evaluate(DummyPath(), '"" zip sequence and (0, nan, "")'), [False])
        self.assertEqual(evaluate(DummyPath(), '0 zip sequence and (true, true)'), [False])
        self.assertEqual(evaluate(DummyPath(), '0 zip sequence and (true, false)'), [False])
        self.assertEqual(evaluate(DummyPath(), '0 zip sequence and (1, nan, "s", "")'), [False])
        self.assertEqual(evaluate(DummyPath(), '0 zip sequence and (1, "s", true)'), [False])
        self.assertEqual(evaluate(DummyPath(), '0 zip sequence and (0, nan, "")'), [False])
        self.assertEqual(evaluate(DummyPath(), 'nan zip sequence and (true, true)'), [False])
        self.assertEqual(evaluate(DummyPath(), 'nan zip sequence and (true, false)'), [False])
        self.assertEqual(evaluate(DummyPath(), 'nan zip sequence and (1, nan, "s", "")'), [False])
        self.assertEqual(evaluate(DummyPath(), 'nan zip sequence and (1, "s", true)'), [False])
        self.assertEqual(evaluate(DummyPath(), 'nan zip sequence and (0, nan, "")'), [False])
        # empty
    ...
    def test_must_apply_and_single_vs_seq_using_zip_all(self):
        ...
        self.assertEqual(evaluate(DummyPath(), 'true zip all and (true, false)'), True)
        self.assertEqual(evaluate(DummyPath(), 'true zip all and (1, nan, "s", "")'), True)
        ...
        self.assertEqual(evaluate(DummyPath(), '"a" zip all and (true, false)'), True)
        self.assertEqual(evaluate(DummyPath(), '"a" zip all and (1, nan, "s", "")'), True)
        ...
        self.assertEqual(evaluate(DummyPath(), '1 zip all and (true, false)'), True)
        self.assertEqual(evaluate(DummyPath(), '1 zip all and (1, nan, "s", "")'), True)
        ...
        self.assertEqual(evaluate(DummyPath(), '1.5 zip all and (true, false)'), True)
        self.assertEqual(evaluate(DummyPath(), '1.5 zip all and (1, nan, "s", "")'), True)
    ...
    def test_must_apply_and_seq_vs_single_using_zip_sequence(self):
        # lhs coerces to true
        self.assertEqual(evaluate(DummyPath(), '(true, true) zip sequence and true'), [True])
        self.assertEqual(evaluate(DummyPath(), '(true, false) zip sequence and true'), [True])
        self.assertEqual(evaluate(DummyPath(), '(1, nan, "s", "") zip sequence and true'), [True])
        self.assertEqual(evaluate(DummyPath(), '(1, "s", true) zip sequence and true'), [True])
        self.assertEqual(evaluate(DummyPath(), '(0, nan, "") zip sequence and true'), [False])
        self.assertEqual(evaluate(DummyPath(), '(true, true) zip sequence and "a"'), [True])
        self.assertEqual(evaluate(DummyPath(), '(true, false) zip sequence and "a"'), [True])
        self.assertEqual(evaluate(DummyPath(), '(1, nan, "s", "") zip sequence and "a"'), [True])
        self.assertEqual(evaluate(DummyPath(), '(1, "s", true) zip sequence and "a"'), [True])
        self.assertEqual(evaluate(DummyPath(), '(0, nan, "") zip sequence and "a"'), [False])
        self.assertEqual(evaluate(DummyPath(), '(true, true) zip sequence and 1'), [True])
        self.assertEqual(evaluate(DummyPath(), '(true, false) zip sequence and 1'), [True])
        self.assertEqual(evaluate(DummyPath(), '(1, nan, "s", "") zip sequence and 1'), [True])
        self.assertEqual(evaluate(DummyPath(), '(1, "s", true) zip sequence and 1'), [True])
        self.assertEqual(evaluate(DummyPath(), '(0, nan, "") zip sequence and 1'), [False])
        self.assertEqual(evaluate(DummyPath(), '(true, true) zip sequence and 1.5'), [True])
        self.assertEqual(evaluate(DummyPath(), '(true, false) zip sequence and 1.5'), [True])
        self.assertEqual(evaluate(DummyPath(), '(1, nan, "s", "") zip sequence and 1.5'), [True])
        self.assertEqual(evaluate(DummyPath(), '(1, "s", true) zip sequence and 1.5'), [True])
        self.assertEqual(evaluate(DummyPath(), '(0, nan, "") zip sequence and 1.5'), [False])
        # lhs coerces to false
        ...
        self.assertEqual(evaluate(DummyPath(), '(1, nan, "s", "") zip sequence and false'), [False])
        self.assertEqual(evaluate(DummyPath(), '(1, "s", False) zip sequence and false'), [False])
        self.assertEqual(evaluate(DummyPath(), '(0, nan, "") zip sequence and false'), [False])
        self.assertEqual(evaluate(DummyPath(), '(true, true) zip sequence and ""'), [False])
        self.assertEqual(evaluate(DummyPath(), '(true, false) zip sequence and ""'), [False])
        self.assertEqual(evaluate(DummyPath(), '(1, nan, "s", "") zip sequence and ""'), [False])
        self.assertEqual(evaluate(DummyPath(), '(1, "s", False) zip sequence and ""'), [False])
        self.assertEqual(evaluate(DummyPath(), '(0, nan, "") zip sequence and ""'), [False])
        self.assertEqual(evaluate(DummyPath(), '(true, true) zip sequence and 0'), [False])
        self.assertEqual(evaluate(DummyPath(), '(true, false) zip sequence and 0'), [False])
        self.assertEqual(evaluate(DummyPath(), '(1, nan, "s", "") zip sequence and 0'), [False])
        self.assertEqual(evaluate(DummyPath(), '(1, "s", true) zip sequence and 0'), [False])
        self.assertEqual(evaluate(DummyPath(), '(0, nan, "") zip sequence and 0'), [False])
        self.assertEqual(evaluate(DummyPath(), '(true, true) zip sequence and nan'), [False])
        self.assertEqual(evaluate(DummyPath(), '(true, false) zip sequence and nan'), [False])
        self.assertEqual(evaluate(DummyPath(), '(1, nan, "s", "") zip sequence and nan'), [False])
        self.assertEqual(evaluate(DummyPath(), '(1, "s", true) zip sequence and nan'), [False])
        self.assertEqual(evaluate(DummyPath(), '(0, nan, "") zip sequence and nan'), [False])
        # empty
    ...
    def test_must_apply_and_seq_vs_single_using_zip_all(self):
        ...
        self.assertEqual(evaluate(DummyPath(), '(true, false) zip all and true'), True)
        self.assertEqual(evaluate(DummyPath(), '(1, nan, "s", "") zip all and true'), True)
        ...
        self.assertEqual(evaluate(DummyPath(), '(true, false) zip all and "a"'), True)
        self.assertEqual(evaluate(DummyPath(), '(1, nan, "s", "") zip all and "a"'), True)
        ...
        self.assertEqual(evaluate(DummyPath(), '(true, false) zip all and 1'), True)
        self.assertEqual(evaluate(DummyPath(), '(1, nan, "s", "") zip all and 1'), True)
        ...
        self.assertEqual(evaluate(DummyPath(), '(true, false) zip all and 1.5'), True)
        self.assertEqual(evaluate(DummyPath(), '(1, nan, "s", "") zip all and 1.5'), True)
