...
class EvaluatorTest(unittest.TestCase):
    ...
    def test_must_not_equal_single_vs_seq_using_zip_any(self):
        ...
        self.assertEqual(evaluate(DummyPath(), '5 zip any != (x, 1)'), True)
    ...
    def test_must_not_equal_single_vs_seq_using_product_sequence(self):
        ...
        self.assertEqual(evaluate(DummyPath(), '"5" product sequence != (5.0, 5.0)'), [False, False])
        self.assertEqual(evaluate(DummyPath(), '"5" product sequence != ("5", "5")'), [False, False])
        self.assertEqual(evaluate(DummyPath(), '5 product sequence != (x, 5)'), [True, False])
        self.assertEqual(evaluate(DummyPath(), '5 product sequence != (x, 1)'), [True, True])
    ...
    def test_must_not_equal_single_vs_seq_using_product_any(self):
        ...
        self.assertEqual(evaluate(DummyPath(), '5 product any != (x, 1)'), True)
        self.assertEqual(evaluate(DummyPath(), '5 product any != ()'), False)

    def test_must_not_equal_single_vs_seq_using_product_all(self):
        self.assertEqual(evaluate(DummyPath(), '6 product all != (5,5)'), True)
        self.assertEqual(evaluate(DummyPath(), '6.0 product all != (5,5)'), True)
        self.assertEqual(evaluate(DummyPath(), '6 product all != (5.0,5.0)'), True)
        self.assertEqual(evaluate(DummyPath(), '6.0 product all != (5.0,5.0)'), True)
        self.assertEqual(evaluate(DummyPath(), '6.0 product all != ("5","5")'), True)
        self.assertEqual(evaluate(DummyPath(), '"6" product all != (5.0, 5.0)'), True)
        self.assertEqual(evaluate(DummyPath(), '"6" product all != ("5", "5")'), True)
        self.assertEqual(evaluate(DummyPath(), '5 product all != (x, 5)'), False)
        self.assertEqual(evaluate(DummyPath(), '5 product all != (x, 1)'), True)
    ...
    def test_must_not_equal_seq_vs_single_using_product_sequence(self):
        ...
        self.assertEqual(evaluate(DummyPath(), '(5.0, 5.0) product sequence != "5"'), [False, False])
        self.assertEqual(evaluate(DummyPath(), '("5", "5") product sequence != "5"'), [False, False])
        self.assertEqual(evaluate(DummyPath(), '(x, 5) product sequence != 5'), [True, False])
        self.assertEqual(evaluate(DummyPath(), '(x, 1) product sequence != 5'), [True, True])
    ...
    def test_must_not_equal_seq_vs_single_using_product_all(self):
        self.assertEqual(evaluate(DummyPath(), '(5,5) product all != 6'), True)
        self.assertEqual(evaluate(DummyPath(), '(5,5) product all != 6.0'), True)
        self.assertEqual(evaluate(DummyPath(), '(5.0,5.0) product all != 6'), True)
        self.assertEqual(evaluate(DummyPath(), '(5.0,5.0) product all != 6.0'), True)
        self.assertEqual(evaluate(DummyPath(), '("5","5") product all != 6.0'), True)
        self.assertEqual(evaluate(DummyPath(), '(5.0, 5.0) product all != "6"'), True)
        self.assertEqual(evaluate(DummyPath(), '("5", "5") product all != "6"'), True)
        self.assertEqual(evaluate(DummyPath(), '(x, 5) product all != 5'), False)
        self.assertEqual(evaluate(DummyPath(), '(x, 1) product all != 5'), True)
        self.assertEqual(evaluate(DummyPath(), '() product all != 5'), True)

    def test_must_not_equal_seq_vs_seq_using_zip_sequence(self):
        self.assertEqual(evaluate(DummyPath(), '(5,6,7) zip sequence != (5,5)'), [False, True])
        self.assertEqual(evaluate(DummyPath(), '(5,5) zip sequence != (5,6,7)'), [False, True])
        self.assertEqual(evaluate(DummyPath(), '(5.0,"6",7) zip sequence != (5,5)'), [False, True])
        self.assertEqual(evaluate(DummyPath(), '(5,5) zip sequence != (5.0,"6",7)'), [False, True])
        self.assertEqual(evaluate(DummyPath(), '(5,5) zip sequence != (x,6)'), [True, True])
        self.assertEqual(evaluate(DummyPath(), '(x,6) zip sequence != (5,5)'), [True, True])
    ...
    def test_must_not_equal_seq_vs_seq_using_zip_any(self):
        ...
        self.assertEqual(evaluate(DummyPath(), '(5,5) zip any != (x,6)'), True)
        self.assertEqual(evaluate(DummyPath(), '(x,6) zip any != (5,5)'), True)
    ...
    def test_must_not_equal_seq_vs_seq_using_zip_all(self):
        self.assertEqual(evaluate(DummyPath(), '(6,7) zip all != (5,5)'), True)
        ...
        self.assertEqual(evaluate(DummyPath(), '(5,5) zip all != (5,5)'), False)
    ...
    def test_must_not_equal_seq_vs_seq_using_product_sequence(self):
        self.assertEqual(evaluate(DummyPath(), '(5,6) product sequence != (5,5)'), [False, False, True, True])
        self.assertEqual(evaluate(DummyPath(), '(5,6) product sequence != (5.0,"6")'), [False, True, True, False])
        self.assertEqual(evaluate(DummyPath(), '(5.0,"6") product sequence != (5,6)'), [False, True, True, False])
    ...
    def test_must_not_equal_seq_vs_seq_using_product_any(self):
        ...
        self.assertEqual(evaluate(DummyPath(), '(5,6) product any != (x,x)'), True)
    ...
    def test_must_not_equal_seq_vs_seq_using_product_all(self):
        ...
        self.assertEqual(evaluate(DummyPath(), '(5,5) product all != (5,5)'), False)
    ...
    def test_must_not_equal_seq_vs_seq(self):  # defualts to using "product any"
        ...
        self.assertEqual(evaluate(DummyPath(), '(5,6) != (x,x)'), True)
