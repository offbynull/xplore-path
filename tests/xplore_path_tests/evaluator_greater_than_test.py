...
class EvaluatorTest(unittest.TestCase):
    ...
    def test_must_be_greater_than_seq_vs_seq_using_zip_sequence(self):
        ...
        self.assertEqual(evaluate(DummyPath(), '(5,5) zip sequence > (5,6,7)'), [False, False])
        self.assertEqual(evaluate(DummyPath(), '(5.0,"6",7) zip sequence > (5,5)'), [False, True])
        self.assertEqual(evaluate(DummyPath(), '(5,5) zip sequence > (5.0,"6",7)'), [False, False])
    ...
    def test_must_be_greater_than_seq_vs_seq_using_zip_any(self):
        ...
        self.assertEqual(evaluate(DummyPath(), '(5,5) zip any > (5,6,7)'), False)
        self.assertEqual(evaluate(DummyPath(), '(5.0,"6",7) zip any > (5,5)'), True)
        self.assertEqual(evaluate(DummyPath(), '(5,5) zip any > (5.0,"6",7)'), False)
