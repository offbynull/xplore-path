...
class EvaluatorTest(unittest.TestCase):
    ...
    def test_must_apply_or_single_vs_seq_using_zip_sequence(self):
        # lhs coerces to true
        self.assertEqual(evaluate(DummyPath(), 'true zip sequence or (true, true)'), [True])
        self.assertEqual(evaluate(DummyPath(), 'true zip sequence or (true, false)'), [True])
        self.assertEqual(evaluate(DummyPath(), 'true zip sequence or (1, nan, "s", "")'), [True])
        self.assertEqual(evaluate(DummyPath(), 'true zip sequence or (1, "s", true)'), [True])
        self.assertEqual(evaluate(DummyPath(), 'true zip sequence or (0, nan, "")'), [True])
        self.assertEqual(evaluate(DummyPath(), '"a" zip sequence or (true, true)'), [True])
        self.assertEqual(evaluate(DummyPath(), '"a" zip sequence or (true, false)'), [True])
        self.assertEqual(evaluate(DummyPath(), '"a" zip sequence or (1, nan, "s", "")'), [True])
        self.assertEqual(evaluate(DummyPath(), '"a" zip sequence or (1, "s", true)'), [True])
        self.assertEqual(evaluate(DummyPath(), '"a" zip sequence or (0, nan, "")'), [True])
        self.assertEqual(evaluate(DummyPath(), '1 zip sequence or (true, true)'), [True])
        self.assertEqual(evaluate(DummyPath(), '1 zip sequence or (true, false)'), [True])
        self.assertEqual(evaluate(DummyPath(), '1 zip sequence or (1, nan, "s", "")'), [True])
        self.assertEqual(evaluate(DummyPath(), '1 zip sequence or (1, "s", true)'), [True])
        self.assertEqual(evaluate(DummyPath(), '1 zip sequence or (0, nan, "")'), [True])
        self.assertEqual(evaluate(DummyPath(), '1.5 zip sequence or (true, true)'), [True])
        self.assertEqual(evaluate(DummyPath(), '1.5 zip sequence or (true, false)'), [True])
        self.assertEqual(evaluate(DummyPath(), '1.5 zip sequence or (1, nan, "s", "")'), [True])
        self.assertEqual(evaluate(DummyPath(), '1.5 zip sequence or (1, "s", true)'), [True])
        self.assertEqual(evaluate(DummyPath(), '1.5 zip sequence or (0, nan, "")'), [True])
        # lhs coerces to false
        self.assertEqual(evaluate(DummyPath(), 'false zip sequence or (true, true)'), [True])
        self.assertEqual(evaluate(DummyPath(), 'false zip sequence or (true, false)'), [True])
        self.assertEqual(evaluate(DummyPath(), 'false zip sequence or (1, nan, "s", "")'), [True])
        self.assertEqual(evaluate(DummyPath(), 'false zip sequence or (1, "s", False)'), [True])
        self.assertEqual(evaluate(DummyPath(), 'false zip sequence or (0, nan, "")'), [False])
        self.assertEqual(evaluate(DummyPath(), '"" zip sequence or (true, true)'), [True])
        self.assertEqual(evaluate(DummyPath(), '"" zip sequence or (true, false)'), [True])
        self.assertEqual(evaluate(DummyPath(), '"" zip sequence or (1, nan, "s", "")'), [True])
        self.assertEqual(evaluate(DummyPath(), '"" zip sequence or (1, "s", False)'), [True])
        self.assertEqual(evaluate(DummyPath(), '"" zip sequence or (0, nan, "")'), [False])
        self.assertEqual(evaluate(DummyPath(), '0 zip sequence or (true, true)'), [True])
        self.assertEqual(evaluate(DummyPath(), '0 zip sequence or (true, false)'), [True])
        self.assertEqual(evaluate(DummyPath(), '0 zip sequence or (1, nan, "s", "")'), [True])
        self.assertEqual(evaluate(DummyPath(), '0 zip sequence or (1, "s", true)'), [True])
        self.assertEqual(evaluate(DummyPath(), '0 zip sequence or (0, nan, "")'), [False])
        self.assertEqual(evaluate(DummyPath(), 'nan zip sequence or (true, true)'), [True])
        self.assertEqual(evaluate(DummyPath(), 'nan zip sequence or (true, false)'), [True])
        self.assertEqual(evaluate(DummyPath(), 'nan zip sequence or (1, nan, "s", "")'), [True])
        self.assertEqual(evaluate(DummyPath(), 'nan zip sequence or (1, "s", true)'), [True])
        self.assertEqual(evaluate(DummyPath(), 'nan zip sequence or (0, nan, "")'), [False])
        # empty
    ...
    def test_must_apply_or_single_vs_seq_using_zip_all(self):
        # lhs coerces to true
        self.assertEqual(evaluate(DummyPath(), 'true zip all or (true, true)'), all([True]))
        self.assertEqual(evaluate(DummyPath(), 'true zip all or (true, false)'), all([True]))
        self.assertEqual(evaluate(DummyPath(), 'true zip all or (1, nan, "s", "")'), all([True]))
        self.assertEqual(evaluate(DummyPath(), 'true zip all or (1, "s", true)'), all([True]))
        self.assertEqual(evaluate(DummyPath(), 'true zip all or (0, nan, "")'), all([True]))
        self.assertEqual(evaluate(DummyPath(), '"a" zip all or (true, true)'), all([True]))
        self.assertEqual(evaluate(DummyPath(), '"a" zip all or (true, false)'), all([True]))
        self.assertEqual(evaluate(DummyPath(), '"a" zip all or (1, nan, "s", "")'), all([True]))
        self.assertEqual(evaluate(DummyPath(), '"a" zip all or (1, "s", true)'), all([True]))
        self.assertEqual(evaluate(DummyPath(), '"a" zip all or (0, nan, "")'), all([True]))
        self.assertEqual(evaluate(DummyPath(), '1 zip all or (true, true)'), all([True]))
        self.assertEqual(evaluate(DummyPath(), '1 zip all or (true, false)'), all([True]))
        self.assertEqual(evaluate(DummyPath(), '1 zip all or (1, nan, "s", "")'), all([True]))
        self.assertEqual(evaluate(DummyPath(), '1 zip all or (1, "s", true)'), all([True]))
        self.assertEqual(evaluate(DummyPath(), '1 zip all or (0, nan, "")'), all([True]))
        self.assertEqual(evaluate(DummyPath(), '1.5 zip all or (true, true)'), all([True]))
        self.assertEqual(evaluate(DummyPath(), '1.5 zip all or (true, false)'), all([True]))
        self.assertEqual(evaluate(DummyPath(), '1.5 zip all or (1, nan, "s", "")'), all([True]))
        self.assertEqual(evaluate(DummyPath(), '1.5 zip all or (1, "s", true)'), all([True]))
        self.assertEqual(evaluate(DummyPath(), '1.5 zip all or (0, nan, "")'), all([True]))
        # lhs coerces to false
        self.assertEqual(evaluate(DummyPath(), 'false zip all or (true, true)'), all([True]))
        self.assertEqual(evaluate(DummyPath(), 'false zip all or (true, false)'), all([True]))
        self.assertEqual(evaluate(DummyPath(), 'false zip all or (1, nan, "s", "")'), all([True]))
        self.assertEqual(evaluate(DummyPath(), 'false zip all or (1, "s", False)'), all([True]))
        self.assertEqual(evaluate(DummyPath(), 'false zip all or (0, nan, "")'), all([False]))
        self.assertEqual(evaluate(DummyPath(), '"" zip all or (true, true)'), all([True]))
        self.assertEqual(evaluate(DummyPath(), '"" zip all or (true, false)'), all([True]))
        self.assertEqual(evaluate(DummyPath(), '"" zip all or (1, nan, "s", "")'), all([True]))
        self.assertEqual(evaluate(DummyPath(), '"" zip all or (1, "s", False)'), all([True]))
        self.assertEqual(evaluate(DummyPath(), '"" zip all or (0, nan, "")'), all([False]))
        self.assertEqual(evaluate(DummyPath(), '0 zip all or (true, true)'), all([True]))
        self.assertEqual(evaluate(DummyPath(), '0 zip all or (true, false)'), all([True]))
        self.assertEqual(evaluate(DummyPath(), '0 zip all or (1, nan, "s", "")'), all([True]))
        self.assertEqual(evaluate(DummyPath(), '0 zip all or (1, "s", true)'), all([True]))
        self.assertEqual(evaluate(DummyPath(), '0 zip all or (0, nan, "")'), all([False]))
        self.assertEqual(evaluate(DummyPath(), 'nan zip all or (true, true)'), all([True]))
        self.assertEqual(evaluate(DummyPath(), 'nan zip all or (true, false)'), all([True]))
        self.assertEqual(evaluate(DummyPath(), 'nan zip all or (1, nan, "s", "")'), all([True]))
        self.assertEqual(evaluate(DummyPath(), 'nan zip all or (1, "s", true)'), all([True]))
        self.assertEqual(evaluate(DummyPath(), 'nan zip all or (0, nan, "")'), all([False]))
        # empty
    ...
    def test_must_apply_or_seq_vs_single_using_zip_sequence(self):
        ...
        self.assertEqual(evaluate(DummyPath(), '(true, false) zip sequence or true'), [True])
        self.assertEqual(evaluate(DummyPath(), '(1, nan, "s", "") zip sequence or true'), [True])
        self.assertEqual(evaluate(DummyPath(), '(1, "s", true) zip sequence or true'), [True])
        self.assertEqual(evaluate(DummyPath(), '(0, nan, "") zip sequence or true'), [True])
        self.assertEqual(evaluate(DummyPath(), '(true, true) zip sequence or "a"'), [True])
        self.assertEqual(evaluate(DummyPath(), '(true, false) zip sequence or "a"'), [True])
        self.assertEqual(evaluate(DummyPath(), '(1, nan, "s", "") zip sequence or "a"'), [True])
        self.assertEqual(evaluate(DummyPath(), '(1, "s", true) zip sequence or "a"'), [True])
        self.assertEqual(evaluate(DummyPath(), '(0, nan, "") zip sequence or "a"'), [True])
        self.assertEqual(evaluate(DummyPath(), '(true, true) zip sequence or 1'), [True])
        self.assertEqual(evaluate(DummyPath(), '(true, false) zip sequence or 1'), [True])
        self.assertEqual(evaluate(DummyPath(), '(1, nan, "s", "") zip sequence or 1'), [True])
        self.assertEqual(evaluate(DummyPath(), '(1, "s", true) zip sequence or 1'), [True])
        self.assertEqual(evaluate(DummyPath(), '(0, nan, "") zip sequence or 1'), [True])
        self.assertEqual(evaluate(DummyPath(), '(true, true) zip sequence or 1.5'), [True])
        self.assertEqual(evaluate(DummyPath(), '(true, false) zip sequence or 1.5'), [True])
        self.assertEqual(evaluate(DummyPath(), '(1, nan, "s", "") zip sequence or 1.5'), [True])
        self.assertEqual(evaluate(DummyPath(), '(1, "s", true) zip sequence or 1.5'), [True])
        self.assertEqual(evaluate(DummyPath(), '(0, nan, "") zip sequence or 1.5'), [True])
        # lhs coerces to false
        self.assertEqual(evaluate(DummyPath(), '(true, true) zip sequence or false'), [True])
        self.assertEqual(evaluate(DummyPath(), '(true, false) zip sequence or false'), [True])
        self.assertEqual(evaluate(DummyPath(), '(1, nan, "s", "") zip sequence or false'), [True])
        self.assertEqual(evaluate(DummyPath(), '(1, "s", False) zip sequence or false'), [True])
        self.assertEqual(evaluate(DummyPath(), '(0, nan, "") zip sequence or false'), [False])
        self.assertEqual(evaluate(DummyPath(), '(true, true) zip sequence or ""'), [True])
        self.assertEqual(evaluate(DummyPath(), '(true, false) zip sequence or ""'), [True])
        self.assertEqual(evaluate(DummyPath(), '(1, nan, "s", "") zip sequence or ""'), [True])
        self.assertEqual(evaluate(DummyPath(), '(1, "s", False) zip sequence or ""'), [True])
        self.assertEqual(evaluate(DummyPath(), '(0, nan, "") zip sequence or ""'), [False])
        self.assertEqual(evaluate(DummyPath(), '(true, true) zip sequence or 0'), [True])
        self.assertEqual(evaluate(DummyPath(), '(true, false) zip sequence or 0'), [True])
        self.assertEqual(evaluate(DummyPath(), '(1, nan, "s", "") zip sequence or 0'), [True])
        self.assertEqual(evaluate(DummyPath(), '(1, "s", true) zip sequence or 0'), [True])
        self.assertEqual(evaluate(DummyPath(), '(0, nan, "") zip sequence or 0'), [False])
        self.assertEqual(evaluate(DummyPath(), '(true, true) zip sequence or nan'), [True])
        self.assertEqual(evaluate(DummyPath(), '(true, false) zip sequence or nan'), [True])
        self.assertEqual(evaluate(DummyPath(), '(1, nan, "s", "") zip sequence or nan'), [True])
        self.assertEqual(evaluate(DummyPath(), '(1, "s", true) zip sequence or nan'), [True])
        self.assertEqual(evaluate(DummyPath(), '(0, nan, "") zip sequence or nan'), [False])
        # empty
    ...
    def test_must_apply_or_seq_vs_single_using_zip_all(self):
        # lhs coerces to true
        self.assertEqual(evaluate(DummyPath(), '(true, true) zip all or true'), all([True]))
        self.assertEqual(evaluate(DummyPath(), '(true, false) zip all or true'), all([True]))
        self.assertEqual(evaluate(DummyPath(), '(1, nan, "s", "") zip all or true'), all([True]))
        self.assertEqual(evaluate(DummyPath(), '(1, "s", true) zip all or true'), all([True]))
        self.assertEqual(evaluate(DummyPath(), '(0, nan, "") zip all or true'), all([True]))
        self.assertEqual(evaluate(DummyPath(), '(true, true) zip all or "a"'), all([True]))
        self.assertEqual(evaluate(DummyPath(), '(true, false) zip all or "a"'), all([True]))
        self.assertEqual(evaluate(DummyPath(), '(1, nan, "s", "") zip all or "a"'), all([True]))
        self.assertEqual(evaluate(DummyPath(), '(1, "s", true) zip all or "a"'), all([True]))
        self.assertEqual(evaluate(DummyPath(), '(0, nan, "") zip all or "a"'), all([True]))
        self.assertEqual(evaluate(DummyPath(), '(true, true) zip all or 1'), all([True]))
        self.assertEqual(evaluate(DummyPath(), '(true, false) zip all or 1'), all([True]))
        self.assertEqual(evaluate(DummyPath(), '(1, nan, "s", "") zip all or 1'), all([True]))
        self.assertEqual(evaluate(DummyPath(), '(1, "s", true) zip all or 1'), all([True]))
        self.assertEqual(evaluate(DummyPath(), '(0, nan, "") zip all or 1'), all([True]))
        self.assertEqual(evaluate(DummyPath(), '(true, true) zip all or 1.5'), all([True]))
        self.assertEqual(evaluate(DummyPath(), '(true, false) zip all or 1.5'), all([True]))
        self.assertEqual(evaluate(DummyPath(), '(1, nan, "s", "") zip all or 1.5'), all([True]))
        self.assertEqual(evaluate(DummyPath(), '(1, "s", true) zip all or 1.5'), all([True]))
        self.assertEqual(evaluate(DummyPath(), '(0, nan, "") zip all or 1.5'), all([True]))
        # lhs coerces to false
        self.assertEqual(evaluate(DummyPath(), '(true, true) zip all or false'), all([True]))
        self.assertEqual(evaluate(DummyPath(), '(true, false) zip all or false'), all([True]))
        self.assertEqual(evaluate(DummyPath(), '(1, nan, "s", "") zip all or false'), all([True]))
        self.assertEqual(evaluate(DummyPath(), '(1, "s", False) zip all or false'), all([True]))
        self.assertEqual(evaluate(DummyPath(), '(0, nan, "") zip all or false'), all([False]))
        self.assertEqual(evaluate(DummyPath(), '(true, true) zip all or ""'), all([True]))
        self.assertEqual(evaluate(DummyPath(), '(true, false) zip all or ""'), all([True,]))
        self.assertEqual(evaluate(DummyPath(), '(1, nan, "s", "") zip all or ""'), all([True]))
        self.assertEqual(evaluate(DummyPath(), '(1, "s", False) zip all or ""'), all([True]))
        self.assertEqual(evaluate(DummyPath(), '(0, nan, "") zip all or ""'), all([False]))
        self.assertEqual(evaluate(DummyPath(), '(true, true) zip all or 0'), all([True]))
        self.assertEqual(evaluate(DummyPath(), '(true, false) zip all or 0'), all([True]))
        self.assertEqual(evaluate(DummyPath(), '(1, nan, "s", "") zip all or 0'), all([True]))
        self.assertEqual(evaluate(DummyPath(), '(1, "s", true) zip all or 0'), all([True]))
        self.assertEqual(evaluate(DummyPath(), '(0, nan, "") zip all or 0'), all([False]))
        self.assertEqual(evaluate(DummyPath(), '(true, true) zip all or nan'), all([True]))
        self.assertEqual(evaluate(DummyPath(), '(true, false) zip all or nan'), all([True]))
        self.assertEqual(evaluate(DummyPath(), '(1, nan, "s", "") zip all or nan'), all([True]))
        self.assertEqual(evaluate(DummyPath(), '(1, "s", true) zip all or nan'), all([True]))
        self.assertEqual(evaluate(DummyPath(), '(0, nan, "") zip all or nan'), all([False]))
        # empty
