...
class EvaluatorTest(unittest.TestCase):
    ...
    def test_must_be_less_than_seq_vs_seq_using_zip_sequence(self):
        root = {}
        self.assertEqual(evaluate(root, '[5,4,3] zip sequence < [5,5]'), [False, True])
        self.assertEqual(evaluate(root, '[5,4,3] < zip sequence [5,5]'), [False, True])
        self.assertEqual(evaluate(root, '[5,5] zip sequence < [5,4,3]'), [False, False])
        self.assertEqual(evaluate(root, '[5,5] < zip sequence [5,4,3]'), [False, False])
        self.assertEqual(evaluate(root, '[5.0,"4",3] zip sequence < [5,5]'), [False, True])
        self.assertEqual(evaluate(root, '[5.0,"4",3] < zip sequence [5,5]'), [False, True])
        self.assertEqual(evaluate(root, '[5,5] zip sequence < [5.0,"4",3]'), [False, False])
        self.assertEqual(evaluate(root, '[5,5] < zip sequence [5.0,"4",3]'), [False, False])
    ...
    def test_must_be_less_than_seq_vs_seq_using_zip_any(self):
        ...
        self.assertEqual(evaluate(root, '[5,4,3] < zip any [5,5]'), True)
        self.assertEqual(evaluate(root, '[5,5] zip any < [5,4,3]'), False)
        self.assertEqual(evaluate(root, '[5,5] < zip any [5,4,3]'), False)
        self.assertEqual(evaluate(root, '[5.0,"4",3] zip any < [5,5]'), True)
        self.assertEqual(evaluate(root, '[5.0,"4",3] < zip any [5,5]'), True)
        self.assertEqual(evaluate(root, '[5,5] zip any < [5.0,"4",3]'), False)
        self.assertEqual(evaluate(root, '[5,5] < zip any [5.0,"4",3]'), False)
    ...
    def test_must_be_less_than_seq_vs_seq_using_zip_all(self):
        root = {}
        self.assertEqual(evaluate(root, '[5,4,3] zip all < [5,5]'), False)
        self.assertEqual(evaluate(root, '[5,4,3] < zip all [5,5]'), False)
        self.assertEqual(evaluate(root, '[5,5] zip all < [5,4,3]'), False)
        self.assertEqual(evaluate(root, '[5,5] < zip all [5,4,3]'), False)
        self.assertEqual(evaluate(root, '[5.0,"4",3] zip all < [5,5]'), False)
        self.assertEqual(evaluate(root, '[5.0,"4",3] < zip all [5,5]'), False)
