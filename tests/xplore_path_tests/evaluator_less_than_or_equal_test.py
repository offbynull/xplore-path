...
class EvaluatorTest(unittest.TestCase):
    ...
    def test_must_be_less_than_or_equal_single_vs_seq_using_zip_sequence(self):
        self.assertEqual(evaluate(DummyPath(), '5 zip sequence <= (5,5)'), [True])
        self.assertEqual(evaluate(DummyPath(), '5.0 zip sequence <= (5,5)'), [True])
        self.assertEqual(evaluate(DummyPath(), '5 zip sequence <= (5.0,5.0)'), [True])
        self.assertEqual(evaluate(DummyPath(), '5.0 zip sequence <= (5.0,5.0)'), [True])
        self.assertEqual(evaluate(DummyPath(), '5.0 zip sequence <= ("5","5")'), [True])
        self.assertEqual(evaluate(DummyPath(), '"5" zip sequence <= (5.0, 5.0)'), [True])
        self.assertEqual(evaluate(DummyPath(), '"5" zip sequence <= ("5", "5")'), [True])
        self.assertEqual(evaluate(DummyPath(), '5 zip sequence <= (x, 5)'), [False])
        self.assertEqual(evaluate(DummyPath(), '5 zip sequence <= (x, 1)'), [False])
    ...
    def test_must_be_less_than_or_equal_seq_vs_single_using_zip_sequence(self):
        self.assertEqual(evaluate(DummyPath(), '(5,5) zip sequence <= 5'), [True])
        self.assertEqual(evaluate(DummyPath(), '(5,5) zip sequence <= 5.0'), [True])
        self.assertEqual(evaluate(DummyPath(), '(5.0,5.0) zip sequence <= 5'), [True])
        self.assertEqual(evaluate(DummyPath(), '(5.0,5.0) zip sequence <= 5.0'), [True])
        self.assertEqual(evaluate(DummyPath(), '("5","5") zip sequence <= 5.0'), [True])
        self.assertEqual(evaluate(DummyPath(), '(5.0, 5.0) zip sequence <= "5"'), [True])
        self.assertEqual(evaluate(DummyPath(), '("5", "5") zip sequence <= "5"'), [True])
        self.assertEqual(evaluate(DummyPath(), '(x, 5) zip sequence <= 5'), [False])
        self.assertEqual(evaluate(DummyPath(), '(x, 1) zip sequence <= 5'), [False])
    ...
    def test_must_be_less_than_or_equal_seq_vs_seq_using_zip_sequence(self):
        self.assertEqual(evaluate(DummyPath(), '(5,4,3) zip sequence <= (5,5)'), [True, True])
        self.assertEqual(evaluate(DummyPath(), '(5,5) zip sequence <= (5,4,3)'), [True, False])
        self.assertEqual(evaluate(DummyPath(), '(5.0,"4",3) zip sequence <= (5,5)'), [True, True])
        self.assertEqual(evaluate(DummyPath(), '(5,5) zip sequence <= (5.0,"4",3)'), [True, False])
    ...
    def test_must_be_less_than_or_equal_seq_vs_seq_using_zip_any(self):
        ...
        self.assertEqual(evaluate(DummyPath(), '(5,5) zip any <= (5,4,3)'), True)
        self.assertEqual(evaluate(DummyPath(), '(5.0,"4",3) zip any <= (5,5)'), True)
        self.assertEqual(evaluate(DummyPath(), '(5,5) zip any <= (5.0,"4",3)'), True)
    ...
    def test_must_be_less_than_or_equal_seq_vs_seq_using_zip_all(self):
        self.assertEqual(evaluate(DummyPath(), '(5,4,3) zip all <= (5,5)'), True)
        self.assertEqual(evaluate(DummyPath(), '(5,5) zip all <= (5,4,3)'), False)
        self.assertEqual(evaluate(DummyPath(), '(5.0,"4",3) zip all <= (5,5)'), True)
