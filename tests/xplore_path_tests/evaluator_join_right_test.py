...
class EvaluatorTest(unittest.TestCase):
    ...
    def test_must_right_join_path_vs_path(self):
        ...
        self._pop_first_and_assert_path(r_actual, ['joined', 'r', 'Banana'], None)
        self._pop_first_and_assert_path(r_actual, ['joined', 'r', 'Banana', 0], 'Southeast Asia')
        self._pop_first_and_assert_path(r_actual, ['joined', 'r', 'Banana', 1], 'Malaysia')
        self._pop_first_and_assert_path(r_actual, ['joined', 'r', 'Banana', 2], 'Indonesia')
        self._pop_first_and_assert_path(r_actual, ['joined'], None)
        ...
        self._pop_first_and_assert_path(r_actual, ['joined'], None)
        self._pop_first_and_assert_path(r_actual, ['joined', 'r'], None)
        self._pop_first_and_assert_path(r_actual, ['joined', 'r', 'Peach'], None)
        self._pop_first_and_assert_path(r_actual, ['joined', 'r', 'Peach', 0], 'China')
        self._pop_first_and_assert_path(r_actual, ['joined'], None)
        self._pop_first_and_assert_path(r_actual, ['joined', 'r'], None)
        self._pop_first_and_assert_path(r_actual, ['joined', 'r', 'Plum'], None)
        self._pop_first_and_assert_path(r_actual, ['joined', 'r', 'Plum', 0], 'China')
        self._pop_first_and_assert_path(r_actual, ['joined', 'r', 'Plum', 1], 'Europe')
        self._pop_first_and_assert_path(r_actual, ['joined'], None)
        self._pop_first_and_assert_path(r_actual, ['joined', 'l'], None)
