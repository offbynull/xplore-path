...
class EvaluatorTest(unittest.TestCase):
    ...
    def test_must_apply_and_single_vs_seq_using_zip_sequence(self):
        ...
        self.assertEqual(evaluate(DummyPath(), 'true and zip sequence [true, true]'), [True, True])
        self.assertEqual(evaluate(DummyPath(), 'true zip sequence and [true, false]'), [True, False])
        self.assertEqual(evaluate(DummyPath(), 'true and zip sequence [true, false]'), [True, False])
        self.assertEqual(evaluate(DummyPath(), 'true zip sequence and [1, nan, "s", ""]'), [True, False, True, False])
        self.assertEqual(evaluate(DummyPath(), 'true and zip sequence [1, nan, "s", ""]'), [True, False, True, False])
        self.assertEqual(evaluate(DummyPath(), 'true zip sequence and [1, "s", true]'), [True, True, True])
        self.assertEqual(evaluate(DummyPath(), 'true and zip sequence [1, "s", true]'), [True, True, True])
        self.assertEqual(evaluate(DummyPath(), 'true zip sequence and [0, nan, ""]'), [False, False, False])
        self.assertEqual(evaluate(DummyPath(), 'true and zip sequence [0, nan, ""]'), [False, False, False])
        self.assertEqual(evaluate(DummyPath(), '"a" zip sequence and [true, true]'), [True, True])
        self.assertEqual(evaluate(DummyPath(), '"a" and zip sequence [true, true]'), [True, True])
        self.assertEqual(evaluate(DummyPath(), '"a" zip sequence and [true, false]'), [True, False])
        self.assertEqual(evaluate(DummyPath(), '"a" and zip sequence [true, false]'), [True, False])
        self.assertEqual(evaluate(DummyPath(), '"a" zip sequence and [1, nan, "s", ""]'), [True, False, True, False])
        self.assertEqual(evaluate(DummyPath(), '"a" and zip sequence [1, nan, "s", ""]'), [True, False, True, False])
        self.assertEqual(evaluate(DummyPath(), '"a" zip sequence and [1, "s", true]'), [True, True, True])
        self.assertEqual(evaluate(DummyPath(), '"a" and zip sequence [1, "s", true]'), [True, True, True])
        self.assertEqual(evaluate(DummyPath(), '"a" zip sequence and [0, nan, ""]'), [False, False, False])
        self.assertEqual(evaluate(DummyPath(), '"a" and zip sequence [0, nan, ""]'), [False, False, False])
        self.assertEqual(evaluate(DummyPath(), '1 zip sequence and [true, true]'), [True, True])
        self.assertEqual(evaluate(DummyPath(), '1 and zip sequence [true, true]'), [True, True])
        self.assertEqual(evaluate(DummyPath(), '1 zip sequence and [true, false]'), [True, False])
        self.assertEqual(evaluate(DummyPath(), '1 and zip sequence [true, false]'), [True, False])
        self.assertEqual(evaluate(DummyPath(), '1 zip sequence and [1, nan, "s", ""]'), [True, False, True, False])
        self.assertEqual(evaluate(DummyPath(), '1 and zip sequence [1, nan, "s", ""]'), [True, False, True, False])
        self.assertEqual(evaluate(DummyPath(), '1 zip sequence and [1, "s", true]'), [True, True, True])
        self.assertEqual(evaluate(DummyPath(), '1 and zip sequence [1, "s", true]'), [True, True, True])
        self.assertEqual(evaluate(DummyPath(), '1 zip sequence and [0, nan, ""]'), [False, False, False])
        self.assertEqual(evaluate(DummyPath(), '1 and zip sequence [0, nan, ""]'), [False, False, False])
        self.assertEqual(evaluate(DummyPath(), '1.5 zip sequence and [true, true]'), [True, True])
        self.assertEqual(evaluate(DummyPath(), '1.5 and zip sequence [true, true]'), [True, True])
        self.assertEqual(evaluate(DummyPath(), '1.5 zip sequence and [true, false]'), [True, False])
        self.assertEqual(evaluate(DummyPath(), '1.5 and zip sequence [true, false]'), [True, False])
        self.assertEqual(evaluate(DummyPath(), '1.5 zip sequence and [1, nan, "s", ""]'), [True, False, True, False])
        self.assertEqual(evaluate(DummyPath(), '1.5 and zip sequence [1, nan, "s", ""]'), [True, False, True, False])
        self.assertEqual(evaluate(DummyPath(), '1.5 zip sequence and [1, "s", true]'), [True, True, True])
        self.assertEqual(evaluate(DummyPath(), '1.5 and zip sequence [1, "s", true]'), [True, True, True])
        self.assertEqual(evaluate(DummyPath(), '1.5 zip sequence and [0, nan, ""]'), [False, False, False])
        self.assertEqual(evaluate(DummyPath(), '1.5 and zip sequence [0, nan, ""]'), [False, False, False])
        # lhs coerces to false
        self.assertEqual(evaluate(DummyPath(), 'false zip sequence and [true, true]'), [False, False])
        self.assertEqual(evaluate(DummyPath(), 'false and zip sequence [true, true]'), [False, False])
        self.assertEqual(evaluate(DummyPath(), 'false zip sequence and [true, false]'), [False, False])
        self.assertEqual(evaluate(DummyPath(), 'false and zip sequence [true, false]'), [False, False])
        self.assertEqual(evaluate(DummyPath(), 'false zip sequence and [1, nan, "s", ""]'), [False, False, False, False])
        self.assertEqual(evaluate(DummyPath(), 'false and zip sequence [1, nan, "s", ""]'), [False, False, False, False])
        self.assertEqual(evaluate(DummyPath(), 'false zip sequence and [1, "s", False]'), [False, False, False])
        self.assertEqual(evaluate(DummyPath(), 'false and zip sequence [1, "s", False]'), [False, False, False])
        self.assertEqual(evaluate(DummyPath(), 'false zip sequence and [0, nan, ""]'), [False, False, False])
        self.assertEqual(evaluate(DummyPath(), 'false and zip sequence [0, nan, ""]'), [False, False, False])
        self.assertEqual(evaluate(DummyPath(), '"" zip sequence and [true, true]'), [False, False])
        self.assertEqual(evaluate(DummyPath(), '"" and zip sequence [true, true]'), [False, False])
        self.assertEqual(evaluate(DummyPath(), '"" zip sequence and [true, false]'), [False, False])
        self.assertEqual(evaluate(DummyPath(), '"" and zip sequence [true, false]'), [False, False])
        self.assertEqual(evaluate(DummyPath(), '"" zip sequence and [1, nan, "s", ""]'), [False, False, False, False])
        self.assertEqual(evaluate(DummyPath(), '"" and zip sequence [1, nan, "s", ""]'), [False, False, False, False])
        self.assertEqual(evaluate(DummyPath(), '"" zip sequence and [1, "s", False]'), [False, False, False])
        self.assertEqual(evaluate(DummyPath(), '"" and zip sequence [1, "s", False]'), [False, False, False])
        self.assertEqual(evaluate(DummyPath(), '"" zip sequence and [0, nan, ""]'), [False, False, False])
        self.assertEqual(evaluate(DummyPath(), '"" and zip sequence [0, nan, ""]'), [False, False, False])
        self.assertEqual(evaluate(DummyPath(), '0 zip sequence and [true, true]'), [False, False])
        self.assertEqual(evaluate(DummyPath(), '0 and zip sequence [true, true]'), [False, False])
        self.assertEqual(evaluate(DummyPath(), '0 zip sequence and [true, false]'), [False, False])
        self.assertEqual(evaluate(DummyPath(), '0 and zip sequence [true, false]'), [False, False])
        self.assertEqual(evaluate(DummyPath(), '0 zip sequence and [1, nan, "s", ""]'), [False, False, False, False])
        self.assertEqual(evaluate(DummyPath(), '0 and zip sequence [1, nan, "s", ""]'), [False, False, False, False])
        self.assertEqual(evaluate(DummyPath(), '0 zip sequence and [1, "s", true]'), [False, False, False])
        self.assertEqual(evaluate(DummyPath(), '0 and zip sequence [1, "s", true]'), [False, False, False])
        self.assertEqual(evaluate(DummyPath(), '0 zip sequence and [0, nan, ""]'), [False, False, False])
        self.assertEqual(evaluate(DummyPath(), '0 and zip sequence [0, nan, ""]'), [False, False, False])
        self.assertEqual(evaluate(DummyPath(), 'nan zip sequence and [true, true]'), [False, False])
        self.assertEqual(evaluate(DummyPath(), 'nan and zip sequence [true, true]'), [False, False])
        self.assertEqual(evaluate(DummyPath(), 'nan zip sequence and [true, false]'), [False, False])
        self.assertEqual(evaluate(DummyPath(), 'nan and zip sequence [true, false]'), [False, False])
        self.assertEqual(evaluate(DummyPath(), 'nan zip sequence and [1, nan, "s", ""]'), [False, False, False, False])
        self.assertEqual(evaluate(DummyPath(), 'nan and zip sequence [1, nan, "s", ""]'), [False, False, False, False])
        self.assertEqual(evaluate(DummyPath(), 'nan zip sequence and [1, "s", true]'), [False, False, False])
        self.assertEqual(evaluate(DummyPath(), 'nan and zip sequence [1, "s", true]'), [False, False, False])
        self.assertEqual(evaluate(DummyPath(), 'nan zip sequence and [0, nan, ""]'), [False, False, False])
        self.assertEqual(evaluate(DummyPath(), 'nan and zip sequence [0, nan, ""]'), [False, False, False])
        # empty
        self.assertEqual(evaluate(DummyPath(), 'true zip sequence and []'), [])
        self.assertEqual(evaluate(DummyPath(), 'true and zip sequence []'), [])
    ...
    def test_must_apply_and_single_vs_seq_using_zip_any(self):
        ...
        self.assertEqual(evaluate(DummyPath(), 'true and zip any [true, true]'), True)
        self.assertEqual(evaluate(DummyPath(), 'true zip any and [true, false]'), True)
        self.assertEqual(evaluate(DummyPath(), 'true and zip any [true, false]'), True)
        self.assertEqual(evaluate(DummyPath(), 'true zip any and [1, nan, "s", ""]'), True)
        self.assertEqual(evaluate(DummyPath(), 'true and zip any [1, nan, "s", ""]'), True)
        self.assertEqual(evaluate(DummyPath(), 'true zip any and [1, "s", true]'), True)
        self.assertEqual(evaluate(DummyPath(), 'true and zip any [1, "s", true]'), True)
        self.assertEqual(evaluate(DummyPath(), 'true zip any and [0, nan, ""]'), False)
        self.assertEqual(evaluate(DummyPath(), 'true and zip any [0, nan, ""]'), False)
        self.assertEqual(evaluate(DummyPath(), '"a" zip any and [true, true]'), True)
        self.assertEqual(evaluate(DummyPath(), '"a" and zip any [true, true]'), True)
        self.assertEqual(evaluate(DummyPath(), '"a" zip any and [true, false]'), True)
        self.assertEqual(evaluate(DummyPath(), '"a" and zip any [true, false]'), True)
        self.assertEqual(evaluate(DummyPath(), '"a" zip any and [1, nan, "s", ""]'), True)
        self.assertEqual(evaluate(DummyPath(), '"a" and zip any [1, nan, "s", ""]'), True)
        self.assertEqual(evaluate(DummyPath(), '"a" zip any and [1, "s", true]'), True)
        self.assertEqual(evaluate(DummyPath(), '"a" and zip any [1, "s", true]'), True)
        self.assertEqual(evaluate(DummyPath(), '"a" zip any and [0, nan, ""]'), False)
        self.assertEqual(evaluate(DummyPath(), '"a" and zip any [0, nan, ""]'), False)
        self.assertEqual(evaluate(DummyPath(), '1 zip any and [true, true]'), True)
        self.assertEqual(evaluate(DummyPath(), '1 and zip any [true, true]'), True)
        self.assertEqual(evaluate(DummyPath(), '1 zip any and [true, false]'), True)
        self.assertEqual(evaluate(DummyPath(), '1 and zip any [true, false]'), True)
        self.assertEqual(evaluate(DummyPath(), '1 zip any and [1, nan, "s", ""]'), True)
        self.assertEqual(evaluate(DummyPath(), '1 and zip any [1, nan, "s", ""]'), True)
        self.assertEqual(evaluate(DummyPath(), '1 zip any and [1, "s", true]'), True)
        self.assertEqual(evaluate(DummyPath(), '1 and zip any [1, "s", true]'), True)
        self.assertEqual(evaluate(DummyPath(), '1 zip any and [0, nan, ""]'), False)
        self.assertEqual(evaluate(DummyPath(), '1 and zip any [0, nan, ""]'), False)
        self.assertEqual(evaluate(DummyPath(), '1.5 zip any and [true, true]'), True)
        self.assertEqual(evaluate(DummyPath(), '1.5 and zip any [true, true]'), True)
        self.assertEqual(evaluate(DummyPath(), '1.5 zip any and [true, false]'), True)
        self.assertEqual(evaluate(DummyPath(), '1.5 and zip any [true, false]'), True)
        self.assertEqual(evaluate(DummyPath(), '1.5 zip any and [1, nan, "s", ""]'), True)
        self.assertEqual(evaluate(DummyPath(), '1.5 and zip any [1, nan, "s", ""]'), True)
        self.assertEqual(evaluate(DummyPath(), '1.5 zip any and [1, "s", true]'), True)
        self.assertEqual(evaluate(DummyPath(), '1.5 and zip any [1, "s", true]'), True)
        self.assertEqual(evaluate(DummyPath(), '1.5 zip any and [0, nan, ""]'), False)
        self.assertEqual(evaluate(DummyPath(), '1.5 and zip any [0, nan, ""]'), False)
        # lhs coerces to false
        self.assertEqual(evaluate(DummyPath(), 'false zip any and [true, true]'), False)
        self.assertEqual(evaluate(DummyPath(), 'false and zip any [true, true]'), False)
        self.assertEqual(evaluate(DummyPath(), 'false zip any and [true, false]'), False)
        self.assertEqual(evaluate(DummyPath(), 'false and zip any [true, false]'), False)
        self.assertEqual(evaluate(DummyPath(), 'false zip any and [1, nan, "s", ""]'), False)
        self.assertEqual(evaluate(DummyPath(), 'false and zip any [1, nan, "s", ""]'), False)
        self.assertEqual(evaluate(DummyPath(), 'false zip any and [1, "s", False]'), False)
        self.assertEqual(evaluate(DummyPath(), 'false and zip any [1, "s", False]'), False)
        self.assertEqual(evaluate(DummyPath(), 'false zip any and [0, nan, ""]'), False)
        self.assertEqual(evaluate(DummyPath(), 'false and zip any [0, nan, ""]'), False)
        self.assertEqual(evaluate(DummyPath(), '"" zip any and [true, true]'), False)
        self.assertEqual(evaluate(DummyPath(), '"" and zip any [true, true]'), False)
        self.assertEqual(evaluate(DummyPath(), '"" zip any and [true, false]'), False)
        self.assertEqual(evaluate(DummyPath(), '"" and zip any [true, false]'), False)
        self.assertEqual(evaluate(DummyPath(), '"" zip any and [1, nan, "s", ""]'), False)
        self.assertEqual(evaluate(DummyPath(), '"" and zip any [1, nan, "s", ""]'), False)
        self.assertEqual(evaluate(DummyPath(), '"" zip any and [1, "s", False]'), False)
        self.assertEqual(evaluate(DummyPath(), '"" and zip any [1, "s", False]'), False)
        self.assertEqual(evaluate(DummyPath(), '"" zip any and [0, nan, ""]'), False)
        self.assertEqual(evaluate(DummyPath(), '"" and zip any [0, nan, ""]'), False)
        self.assertEqual(evaluate(DummyPath(), '0 zip any and [true, true]'), False)
        self.assertEqual(evaluate(DummyPath(), '0 and zip any [true, true]'), False)
        self.assertEqual(evaluate(DummyPath(), '0 zip any and [true, false]'), False)
        self.assertEqual(evaluate(DummyPath(), '0 and zip any [true, false]'), False)
        self.assertEqual(evaluate(DummyPath(), '0 zip any and [1, nan, "s", ""]'), False)
        self.assertEqual(evaluate(DummyPath(), '0 and zip any [1, nan, "s", ""]'), False)
        self.assertEqual(evaluate(DummyPath(), '0 zip any and [1, "s", true]'), False)
        self.assertEqual(evaluate(DummyPath(), '0 and zip any [1, "s", true]'), False)
        self.assertEqual(evaluate(DummyPath(), '0 zip any and [0, nan, ""]'), False)
        self.assertEqual(evaluate(DummyPath(), '0 and zip any [0, nan, ""]'), False)
        self.assertEqual(evaluate(DummyPath(), 'nan zip any and [true, true]'), False)
        self.assertEqual(evaluate(DummyPath(), 'nan and zip any [true, true]'), False)
        self.assertEqual(evaluate(DummyPath(), 'nan zip any and [true, false]'), False)
        self.assertEqual(evaluate(DummyPath(), 'nan and zip any [true, false]'), False)
        self.assertEqual(evaluate(DummyPath(), 'nan zip any and [1, nan, "s", ""]'), False)
        self.assertEqual(evaluate(DummyPath(), 'nan and zip any [1, nan, "s", ""]'), False)
        self.assertEqual(evaluate(DummyPath(), 'nan zip any and [1, "s", true]'), False)
        self.assertEqual(evaluate(DummyPath(), 'nan and zip any [1, "s", true]'), False)
        self.assertEqual(evaluate(DummyPath(), 'nan zip any and [0, nan, ""]'), False)
        self.assertEqual(evaluate(DummyPath(), 'nan and zip any [0, nan, ""]'), False)
        # empty
        self.assertEqual(evaluate(DummyPath(), 'true zip any and []'), False)
        self.assertEqual(evaluate(DummyPath(), 'true and zip any []'), False)
    ...
    def test_must_apply_and_single_vs_seq_using_zip_all(self):
        ...
        self.assertEqual(evaluate(DummyPath(), 'true and zip all [true, true]'), True)
        self.assertEqual(evaluate(DummyPath(), 'true zip all and [true, false]'), False)
        self.assertEqual(evaluate(DummyPath(), 'true and zip all [true, false]'), False)
        self.assertEqual(evaluate(DummyPath(), 'true zip all and [1, nan, "s", ""]'), False)
        self.assertEqual(evaluate(DummyPath(), 'true and zip all [1, nan, "s", ""]'), False)
        self.assertEqual(evaluate(DummyPath(), 'true zip all and [1, "s", true]'), True)
        self.assertEqual(evaluate(DummyPath(), 'true and zip all [1, "s", true]'), True)
        self.assertEqual(evaluate(DummyPath(), 'true zip all and [0, nan, ""]'), False)
        self.assertEqual(evaluate(DummyPath(), 'true and zip all [0, nan, ""]'), False)
        self.assertEqual(evaluate(DummyPath(), '"a" zip all and [true, true]'), True)
        self.assertEqual(evaluate(DummyPath(), '"a" and zip all [true, true]'), True)
        self.assertEqual(evaluate(DummyPath(), '"a" zip all and [true, false]'), False)
        self.assertEqual(evaluate(DummyPath(), '"a" and zip all [true, false]'), False)
        self.assertEqual(evaluate(DummyPath(), '"a" zip all and [1, nan, "s", ""]'), False)
        self.assertEqual(evaluate(DummyPath(), '"a" and zip all [1, nan, "s", ""]'), False)
        self.assertEqual(evaluate(DummyPath(), '"a" zip all and [1, "s", true]'), True)
        self.assertEqual(evaluate(DummyPath(), '"a" and zip all [1, "s", true]'), True)
        self.assertEqual(evaluate(DummyPath(), '"a" zip all and [0, nan, ""]'), False)
        self.assertEqual(evaluate(DummyPath(), '"a" and zip all [0, nan, ""]'), False)
        self.assertEqual(evaluate(DummyPath(), '1 zip all and [true, true]'), True)
        self.assertEqual(evaluate(DummyPath(), '1 and zip all [true, true]'), True)
        self.assertEqual(evaluate(DummyPath(), '1 zip all and [true, false]'), False)
        self.assertEqual(evaluate(DummyPath(), '1 and zip all [true, false]'), False)
        self.assertEqual(evaluate(DummyPath(), '1 zip all and [1, nan, "s", ""]'), False)
        self.assertEqual(evaluate(DummyPath(), '1 and zip all [1, nan, "s", ""]'), False)
        self.assertEqual(evaluate(DummyPath(), '1 zip all and [1, "s", true]'), True)
        self.assertEqual(evaluate(DummyPath(), '1 and zip all [1, "s", true]'), True)
        self.assertEqual(evaluate(DummyPath(), '1 zip all and [0, nan, ""]'), False)
        self.assertEqual(evaluate(DummyPath(), '1 and zip all [0, nan, ""]'), False)
        self.assertEqual(evaluate(DummyPath(), '1.5 zip all and [true, true]'), True)
        self.assertEqual(evaluate(DummyPath(), '1.5 and zip all [true, true]'), True)
        self.assertEqual(evaluate(DummyPath(), '1.5 zip all and [true, false]'), False)
        self.assertEqual(evaluate(DummyPath(), '1.5 and zip all [true, false]'), False)
        self.assertEqual(evaluate(DummyPath(), '1.5 zip all and [1, nan, "s", ""]'), False)
        self.assertEqual(evaluate(DummyPath(), '1.5 and zip all [1, nan, "s", ""]'), False)
        self.assertEqual(evaluate(DummyPath(), '1.5 zip all and [1, "s", true]'), True)
        self.assertEqual(evaluate(DummyPath(), '1.5 and zip all [1, "s", true]'), True)
        self.assertEqual(evaluate(DummyPath(), '1.5 zip all and [0, nan, ""]'), False)
        self.assertEqual(evaluate(DummyPath(), '1.5 and zip all [0, nan, ""]'), False)
        # lhs coerces to false
        self.assertEqual(evaluate(DummyPath(), 'false zip all and [true, true]'), False)
        self.assertEqual(evaluate(DummyPath(), 'false and zip all [true, true]'), False)
        self.assertEqual(evaluate(DummyPath(), 'false zip all and [true, false]'), False)
        self.assertEqual(evaluate(DummyPath(), 'false and zip all [true, false]'), False)
        self.assertEqual(evaluate(DummyPath(), 'false zip all and [1, nan, "s", ""]'), False)
        self.assertEqual(evaluate(DummyPath(), 'false and zip all [1, nan, "s", ""]'), False)
        self.assertEqual(evaluate(DummyPath(), 'false zip all and [1, "s", False]'), False)
        self.assertEqual(evaluate(DummyPath(), 'false and zip all [1, "s", False]'), False)
        self.assertEqual(evaluate(DummyPath(), 'false zip all and [0, nan, ""]'), False)
        self.assertEqual(evaluate(DummyPath(), 'false and zip all [0, nan, ""]'), False)
        self.assertEqual(evaluate(DummyPath(), '"" zip all and [true, true]'), False)
        self.assertEqual(evaluate(DummyPath(), '"" and zip all [true, true]'), False)
        self.assertEqual(evaluate(DummyPath(), '"" zip all and [true, false]'), False)
        self.assertEqual(evaluate(DummyPath(), '"" and zip all [true, false]'), False)
        self.assertEqual(evaluate(DummyPath(), '"" zip all and [1, nan, "s", ""]'), False)
        self.assertEqual(evaluate(DummyPath(), '"" and zip all [1, nan, "s", ""]'), False)
        self.assertEqual(evaluate(DummyPath(), '"" zip all and [1, "s", False]'), False)
        self.assertEqual(evaluate(DummyPath(), '"" and zip all [1, "s", False]'), False)
        self.assertEqual(evaluate(DummyPath(), '"" zip all and [0, nan, ""]'), False)
        self.assertEqual(evaluate(DummyPath(), '"" and zip all [0, nan, ""]'), False)
        self.assertEqual(evaluate(DummyPath(), '0 zip all and [true, true]'), False)
        self.assertEqual(evaluate(DummyPath(), '0 and zip all [true, true]'), False)
        self.assertEqual(evaluate(DummyPath(), '0 zip all and [true, false]'), False)
        self.assertEqual(evaluate(DummyPath(), '0 and zip all [true, false]'), False)
        self.assertEqual(evaluate(DummyPath(), '0 zip all and [1, nan, "s", ""]'), False)
        self.assertEqual(evaluate(DummyPath(), '0 and zip all [1, nan, "s", ""]'), False)
        self.assertEqual(evaluate(DummyPath(), '0 zip all and [1, "s", true]'), False)
        self.assertEqual(evaluate(DummyPath(), '0 and zip all [1, "s", true]'), False)
        self.assertEqual(evaluate(DummyPath(), '0 zip all and [0, nan, ""]'), False)
        self.assertEqual(evaluate(DummyPath(), '0 and zip all [0, nan, ""]'), False)
        self.assertEqual(evaluate(DummyPath(), 'nan zip all and [true, true]'), False)
        self.assertEqual(evaluate(DummyPath(), 'nan and zip all [true, true]'), False)
        self.assertEqual(evaluate(DummyPath(), 'nan zip all and [true, false]'), False)
        self.assertEqual(evaluate(DummyPath(), 'nan and zip all [true, false]'), False)
        self.assertEqual(evaluate(DummyPath(), 'nan zip all and [1, nan, "s", ""]'), False)
        self.assertEqual(evaluate(DummyPath(), 'nan and zip all [1, nan, "s", ""]'), False)
        self.assertEqual(evaluate(DummyPath(), 'nan zip all and [1, "s", true]'), False)
        self.assertEqual(evaluate(DummyPath(), 'nan and zip all [1, "s", true]'), False)
        self.assertEqual(evaluate(DummyPath(), 'nan zip all and [0, nan, ""]'), False)
        self.assertEqual(evaluate(DummyPath(), 'nan and zip all [0, nan, ""]'), False)
        # empty
        self.assertEqual(evaluate(DummyPath(), 'true zip all and []'), True)
        self.assertEqual(evaluate(DummyPath(), 'true and zip all []'), True)
    ...
    def test_must_apply_and_single_vs_seq_using_product_sequence(self):
        ...
        self.assertEqual(evaluate(DummyPath(), 'true and product sequence [true, true]'), [True, True])
        self.assertEqual(evaluate(DummyPath(), 'true product sequence and [true, false]'), [True, False])
        self.assertEqual(evaluate(DummyPath(), 'true and product sequence [true, false]'), [True, False])
        self.assertEqual(evaluate(DummyPath(), 'true product sequence and [1, nan, "s", ""]'), [True, False, True, False])
        self.assertEqual(evaluate(DummyPath(), 'true and product sequence [1, nan, "s", ""]'), [True, False, True, False])
        self.assertEqual(evaluate(DummyPath(), 'true product sequence and [1, "s", true]'), [True, True, True])
        self.assertEqual(evaluate(DummyPath(), 'true and product sequence [1, "s", true]'), [True, True, True])
        self.assertEqual(evaluate(DummyPath(), 'true product sequence and [0, nan, ""]'), [False, False, False])
        self.assertEqual(evaluate(DummyPath(), 'true and product sequence [0, nan, ""]'), [False, False, False])
        self.assertEqual(evaluate(DummyPath(), '"a" product sequence and [true, true]'), [True, True])
        self.assertEqual(evaluate(DummyPath(), '"a" and product sequence [true, true]'), [True, True])
        self.assertEqual(evaluate(DummyPath(), '"a" product sequence and [true, false]'), [True, False])
        self.assertEqual(evaluate(DummyPath(), '"a" and product sequence [true, false]'), [True, False])
        self.assertEqual(evaluate(DummyPath(), '"a" product sequence and [1, nan, "s", ""]'), [True, False, True, False])
        self.assertEqual(evaluate(DummyPath(), '"a" and product sequence [1, nan, "s", ""]'), [True, False, True, False])
        self.assertEqual(evaluate(DummyPath(), '"a" product sequence and [1, "s", true]'), [True, True, True])
        self.assertEqual(evaluate(DummyPath(), '"a" and product sequence [1, "s", true]'), [True, True, True])
        self.assertEqual(evaluate(DummyPath(), '"a" product sequence and [0, nan, ""]'), [False, False, False])
        self.assertEqual(evaluate(DummyPath(), '"a" and product sequence [0, nan, ""]'), [False, False, False])
        self.assertEqual(evaluate(DummyPath(), '1 product sequence and [true, true]'), [True, True])
        self.assertEqual(evaluate(DummyPath(), '1 and product sequence [true, true]'), [True, True])
        self.assertEqual(evaluate(DummyPath(), '1 product sequence and [true, false]'), [True, False])
        self.assertEqual(evaluate(DummyPath(), '1 and product sequence [true, false]'), [True, False])
        self.assertEqual(evaluate(DummyPath(), '1 product sequence and [1, nan, "s", ""]'), [True, False, True, False])
        self.assertEqual(evaluate(DummyPath(), '1 and product sequence [1, nan, "s", ""]'), [True, False, True, False])
        self.assertEqual(evaluate(DummyPath(), '1 product sequence and [1, "s", true]'), [True, True, True])
        self.assertEqual(evaluate(DummyPath(), '1 and product sequence [1, "s", true]'), [True, True, True])
        self.assertEqual(evaluate(DummyPath(), '1 product sequence and [0, nan, ""]'), [False, False, False])
        self.assertEqual(evaluate(DummyPath(), '1 and product sequence [0, nan, ""]'), [False, False, False])
        self.assertEqual(evaluate(DummyPath(), '1.5 product sequence and [true, true]'), [True, True])
        self.assertEqual(evaluate(DummyPath(), '1.5 and product sequence [true, true]'), [True, True])
        self.assertEqual(evaluate(DummyPath(), '1.5 product sequence and [true, false]'), [True, False])
        self.assertEqual(evaluate(DummyPath(), '1.5 and product sequence [true, false]'), [True, False])
        self.assertEqual(evaluate(DummyPath(), '1.5 product sequence and [1, nan, "s", ""]'), [True, False, True, False])
        self.assertEqual(evaluate(DummyPath(), '1.5 and product sequence [1, nan, "s", ""]'), [True, False, True, False])
        self.assertEqual(evaluate(DummyPath(), '1.5 product sequence and [1, "s", true]'), [True, True, True])
        self.assertEqual(evaluate(DummyPath(), '1.5 and product sequence [1, "s", true]'), [True, True, True])
        self.assertEqual(evaluate(DummyPath(), '1.5 product sequence and [0, nan, ""]'), [False, False, False])
        self.assertEqual(evaluate(DummyPath(), '1.5 and product sequence [0, nan, ""]'), [False, False, False])
        # lhs coerces to false
        self.assertEqual(evaluate(DummyPath(), 'false product sequence and [true, true]'), [False, False])
        self.assertEqual(evaluate(DummyPath(), 'false and product sequence [true, true]'), [False, False])
        self.assertEqual(evaluate(DummyPath(), 'false product sequence and [true, false]'), [False, False])
        self.assertEqual(evaluate(DummyPath(), 'false and product sequence [true, false]'), [False, False])
        self.assertEqual(evaluate(DummyPath(), 'false product sequence and [1, nan, "s", ""]'), [False, False, False, False])
        self.assertEqual(evaluate(DummyPath(), 'false and product sequence [1, nan, "s", ""]'), [False, False, False, False])
        self.assertEqual(evaluate(DummyPath(), 'false product sequence and [1, "s", False]'), [False, False, False])
        self.assertEqual(evaluate(DummyPath(), 'false and product sequence [1, "s", False]'), [False, False, False])
        self.assertEqual(evaluate(DummyPath(), 'false product sequence and [0, nan, ""]'), [False, False, False])
        self.assertEqual(evaluate(DummyPath(), 'false and product sequence [0, nan, ""]'), [False, False, False])
        self.assertEqual(evaluate(DummyPath(), '"" product sequence and [true, true]'), [False, False])
        self.assertEqual(evaluate(DummyPath(), '"" and product sequence [true, true]'), [False, False])
        self.assertEqual(evaluate(DummyPath(), '"" product sequence and [true, false]'), [False, False])
        self.assertEqual(evaluate(DummyPath(), '"" and product sequence [true, false]'), [False, False])
        self.assertEqual(evaluate(DummyPath(), '"" product sequence and [1, nan, "s", ""]'), [False, False, False, False])
        self.assertEqual(evaluate(DummyPath(), '"" and product sequence [1, nan, "s", ""]'), [False, False, False, False])
        self.assertEqual(evaluate(DummyPath(), '"" product sequence and [1, "s", False]'), [False, False, False])
        self.assertEqual(evaluate(DummyPath(), '"" and product sequence [1, "s", False]'), [False, False, False])
        self.assertEqual(evaluate(DummyPath(), '"" product sequence and [0, nan, ""]'), [False, False, False])
        self.assertEqual(evaluate(DummyPath(), '"" and product sequence [0, nan, ""]'), [False, False, False])
        self.assertEqual(evaluate(DummyPath(), '0 product sequence and [true, true]'), [False, False])
        self.assertEqual(evaluate(DummyPath(), '0 and product sequence [true, true]'), [False, False])
        self.assertEqual(evaluate(DummyPath(), '0 product sequence and [true, false]'), [False, False])
        self.assertEqual(evaluate(DummyPath(), '0 and product sequence [true, false]'), [False, False])
        self.assertEqual(evaluate(DummyPath(), '0 product sequence and [1, nan, "s", ""]'), [False, False, False, False])
        self.assertEqual(evaluate(DummyPath(), '0 and product sequence [1, nan, "s", ""]'), [False, False, False, False])
        self.assertEqual(evaluate(DummyPath(), '0 product sequence and [1, "s", true]'), [False, False, False])
        self.assertEqual(evaluate(DummyPath(), '0 and product sequence [1, "s", true]'), [False, False, False])
        self.assertEqual(evaluate(DummyPath(), '0 product sequence and [0, nan, ""]'), [False, False, False])
        self.assertEqual(evaluate(DummyPath(), '0 and product sequence [0, nan, ""]'), [False, False, False])
        self.assertEqual(evaluate(DummyPath(), 'nan product sequence and [true, true]'), [False, False])
        self.assertEqual(evaluate(DummyPath(), 'nan and product sequence [true, true]'), [False, False])
        self.assertEqual(evaluate(DummyPath(), 'nan product sequence and [true, false]'), [False, False])
        self.assertEqual(evaluate(DummyPath(), 'nan and product sequence [true, false]'), [False, False])
        self.assertEqual(evaluate(DummyPath(), 'nan product sequence and [1, nan, "s", ""]'), [False, False, False, False])
        self.assertEqual(evaluate(DummyPath(), 'nan and product sequence [1, nan, "s", ""]'), [False, False, False, False])
        self.assertEqual(evaluate(DummyPath(), 'nan product sequence and [1, "s", true]'), [False, False, False])
        self.assertEqual(evaluate(DummyPath(), 'nan and product sequence [1, "s", true]'), [False, False, False])
        self.assertEqual(evaluate(DummyPath(), 'nan product sequence and [0, nan, ""]'), [False, False, False])
        self.assertEqual(evaluate(DummyPath(), 'nan and product sequence [0, nan, ""]'), [False, False, False])
        # empty
        self.assertEqual(evaluate(DummyPath(), 'true product sequence and []'), [])
        self.assertEqual(evaluate(DummyPath(), 'true and product sequence []'), [])
    ...
    def test_must_apply_and_single_vs_seq_using_product_any(self):
        ...
        self.assertEqual(evaluate(DummyPath(), 'true and product any [true, true]'), True)
        self.assertEqual(evaluate(DummyPath(), 'true product any and [true, false]'), True)
        self.assertEqual(evaluate(DummyPath(), 'true and product any [true, false]'), True)
        self.assertEqual(evaluate(DummyPath(), 'true product any and [1, nan, "s", ""]'), True)
        self.assertEqual(evaluate(DummyPath(), 'true and product any [1, nan, "s", ""]'), True)
        self.assertEqual(evaluate(DummyPath(), 'true product any and [1, "s", true]'), True)
        self.assertEqual(evaluate(DummyPath(), 'true and product any [1, "s", true]'), True)
        self.assertEqual(evaluate(DummyPath(), 'true product any and [0, nan, ""]'), False)
        self.assertEqual(evaluate(DummyPath(), 'true and product any [0, nan, ""]'), False)
        self.assertEqual(evaluate(DummyPath(), '"a" product any and [true, true]'), True)
        self.assertEqual(evaluate(DummyPath(), '"a" and product any [true, true]'), True)
        self.assertEqual(evaluate(DummyPath(), '"a" product any and [true, false]'), True)
        self.assertEqual(evaluate(DummyPath(), '"a" and product any [true, false]'), True)
        self.assertEqual(evaluate(DummyPath(), '"a" product any and [1, nan, "s", ""]'), True)
        self.assertEqual(evaluate(DummyPath(), '"a" and product any [1, nan, "s", ""]'), True)
        self.assertEqual(evaluate(DummyPath(), '"a" product any and [1, "s", true]'), True)
        self.assertEqual(evaluate(DummyPath(), '"a" and product any [1, "s", true]'), True)
        self.assertEqual(evaluate(DummyPath(), '"a" product any and [0, nan, ""]'), False)
        self.assertEqual(evaluate(DummyPath(), '"a" and product any [0, nan, ""]'), False)
        self.assertEqual(evaluate(DummyPath(), '1 product any and [true, true]'), True)
        self.assertEqual(evaluate(DummyPath(), '1 and product any [true, true]'), True)
        self.assertEqual(evaluate(DummyPath(), '1 product any and [true, false]'), True)
        self.assertEqual(evaluate(DummyPath(), '1 and product any [true, false]'), True)
        self.assertEqual(evaluate(DummyPath(), '1 product any and [1, nan, "s", ""]'), True)
        self.assertEqual(evaluate(DummyPath(), '1 and product any [1, nan, "s", ""]'), True)
        self.assertEqual(evaluate(DummyPath(), '1 product any and [1, "s", true]'), True)
        self.assertEqual(evaluate(DummyPath(), '1 and product any [1, "s", true]'), True)
        self.assertEqual(evaluate(DummyPath(), '1 product any and [0, nan, ""]'), False)
        self.assertEqual(evaluate(DummyPath(), '1 and product any [0, nan, ""]'), False)
        self.assertEqual(evaluate(DummyPath(), '1.5 product any and [true, true]'), True)
        self.assertEqual(evaluate(DummyPath(), '1.5 and product any [true, true]'), True)
        self.assertEqual(evaluate(DummyPath(), '1.5 product any and [true, false]'), True)
        self.assertEqual(evaluate(DummyPath(), '1.5 and product any [true, false]'), True)
        self.assertEqual(evaluate(DummyPath(), '1.5 product any and [1, nan, "s", ""]'), True)
        self.assertEqual(evaluate(DummyPath(), '1.5 and product any [1, nan, "s", ""]'), True)
        self.assertEqual(evaluate(DummyPath(), '1.5 product any and [1, "s", true]'), True)
        self.assertEqual(evaluate(DummyPath(), '1.5 and product any [1, "s", true]'), True)
        self.assertEqual(evaluate(DummyPath(), '1.5 product any and [0, nan, ""]'), False)
        self.assertEqual(evaluate(DummyPath(), '1.5 and product any [0, nan, ""]'), False)
        # lhs coerces to false
        self.assertEqual(evaluate(DummyPath(), 'false product any and [true, true]'), False)
        self.assertEqual(evaluate(DummyPath(), 'false and product any [true, true]'), False)
        self.assertEqual(evaluate(DummyPath(), 'false product any and [true, false]'), False)
        self.assertEqual(evaluate(DummyPath(), 'false and product any [true, false]'), False)
        self.assertEqual(evaluate(DummyPath(), 'false product any and [1, nan, "s", ""]'), False)
        self.assertEqual(evaluate(DummyPath(), 'false and product any [1, nan, "s", ""]'), False)
        self.assertEqual(evaluate(DummyPath(), 'false product any and [1, "s", False]'), False)
        self.assertEqual(evaluate(DummyPath(), 'false and product any [1, "s", False]'), False)
        self.assertEqual(evaluate(DummyPath(), 'false product any and [0, nan, ""]'), False)
        self.assertEqual(evaluate(DummyPath(), 'false and product any [0, nan, ""]'), False)
        self.assertEqual(evaluate(DummyPath(), '"" product any and [true, true]'), False)
        self.assertEqual(evaluate(DummyPath(), '"" and product any [true, true]'), False)
        self.assertEqual(evaluate(DummyPath(), '"" product any and [true, false]'), False)
        self.assertEqual(evaluate(DummyPath(), '"" and product any [true, false]'), False)
        self.assertEqual(evaluate(DummyPath(), '"" product any and [1, nan, "s", ""]'), False)
        self.assertEqual(evaluate(DummyPath(), '"" and product any [1, nan, "s", ""]'), False)
        self.assertEqual(evaluate(DummyPath(), '"" product any and [1, "s", False]'), False)
        self.assertEqual(evaluate(DummyPath(), '"" and product any [1, "s", False]'), False)
        self.assertEqual(evaluate(DummyPath(), '"" product any and [0, nan, ""]'), False)
        self.assertEqual(evaluate(DummyPath(), '"" and product any [0, nan, ""]'), False)
        self.assertEqual(evaluate(DummyPath(), '0 product any and [true, true]'), False)
        self.assertEqual(evaluate(DummyPath(), '0 and product any [true, true]'), False)
        self.assertEqual(evaluate(DummyPath(), '0 product any and [true, false]'), False)
        self.assertEqual(evaluate(DummyPath(), '0 and product any [true, false]'), False)
        self.assertEqual(evaluate(DummyPath(), '0 product any and [1, nan, "s", ""]'), False)
        self.assertEqual(evaluate(DummyPath(), '0 and product any [1, nan, "s", ""]'), False)
        self.assertEqual(evaluate(DummyPath(), '0 product any and [1, "s", true]'), False)
        self.assertEqual(evaluate(DummyPath(), '0 and product any [1, "s", true]'), False)
        self.assertEqual(evaluate(DummyPath(), '0 product any and [0, nan, ""]'), False)
        self.assertEqual(evaluate(DummyPath(), '0 and product any [0, nan, ""]'), False)
        self.assertEqual(evaluate(DummyPath(), 'nan product any and [true, true]'), False)
        self.assertEqual(evaluate(DummyPath(), 'nan and product any [true, true]'), False)
        self.assertEqual(evaluate(DummyPath(), 'nan product any and [true, false]'), False)
        self.assertEqual(evaluate(DummyPath(), 'nan and product any [true, false]'), False)
        self.assertEqual(evaluate(DummyPath(), 'nan product any and [1, nan, "s", ""]'), False)
        self.assertEqual(evaluate(DummyPath(), 'nan and product any [1, nan, "s", ""]'), False)
        self.assertEqual(evaluate(DummyPath(), 'nan product any and [1, "s", true]'), False)
        self.assertEqual(evaluate(DummyPath(), 'nan and product any [1, "s", true]'), False)
        self.assertEqual(evaluate(DummyPath(), 'nan product any and [0, nan, ""]'), False)
        self.assertEqual(evaluate(DummyPath(), 'nan and product any [0, nan, ""]'), False)
        # empty
        self.assertEqual(evaluate(DummyPath(), 'true product any and []'), False)
        self.assertEqual(evaluate(DummyPath(), 'true and product any []'), False)
    ...
    def test_must_apply_and_single_vs_seq_using_product_all(self):
        ...
        self.assertEqual(evaluate(DummyPath(), 'true and product all [true, true]'), True)
        self.assertEqual(evaluate(DummyPath(), 'true product all and [true, false]'), False)
        self.assertEqual(evaluate(DummyPath(), 'true and product all [true, false]'), False)
        self.assertEqual(evaluate(DummyPath(), 'true product all and [1, nan, "s", ""]'), False)
        self.assertEqual(evaluate(DummyPath(), 'true and product all [1, nan, "s", ""]'), False)
        self.assertEqual(evaluate(DummyPath(), 'true product all and [1, "s", true]'), True)
        self.assertEqual(evaluate(DummyPath(), 'true and product all [1, "s", true]'), True)
        self.assertEqual(evaluate(DummyPath(), 'true product all and [0, nan, ""]'), False)
        self.assertEqual(evaluate(DummyPath(), 'true and product all [0, nan, ""]'), False)
        self.assertEqual(evaluate(DummyPath(), '"a" product all and [true, true]'), True)
        self.assertEqual(evaluate(DummyPath(), '"a" and product all [true, true]'), True)
        self.assertEqual(evaluate(DummyPath(), '"a" product all and [true, false]'), False)
        self.assertEqual(evaluate(DummyPath(), '"a" and product all [true, false]'), False)
        self.assertEqual(evaluate(DummyPath(), '"a" product all and [1, nan, "s", ""]'), False)
        self.assertEqual(evaluate(DummyPath(), '"a" and product all [1, nan, "s", ""]'), False)
        self.assertEqual(evaluate(DummyPath(), '"a" product all and [1, "s", true]'), True)
        self.assertEqual(evaluate(DummyPath(), '"a" and product all [1, "s", true]'), True)
        self.assertEqual(evaluate(DummyPath(), '"a" product all and [0, nan, ""]'), False)
        self.assertEqual(evaluate(DummyPath(), '"a" and product all [0, nan, ""]'), False)
        self.assertEqual(evaluate(DummyPath(), '1 product all and [true, true]'), True)
        self.assertEqual(evaluate(DummyPath(), '1 and product all [true, true]'), True)
        self.assertEqual(evaluate(DummyPath(), '1 product all and [true, false]'), False)
        self.assertEqual(evaluate(DummyPath(), '1 and product all [true, false]'), False)
        self.assertEqual(evaluate(DummyPath(), '1 product all and [1, nan, "s", ""]'), False)
        self.assertEqual(evaluate(DummyPath(), '1 and product all [1, nan, "s", ""]'), False)
        self.assertEqual(evaluate(DummyPath(), '1 product all and [1, "s", true]'), True)
        self.assertEqual(evaluate(DummyPath(), '1 and product all [1, "s", true]'), True)
        self.assertEqual(evaluate(DummyPath(), '1 product all and [0, nan, ""]'), False)
        self.assertEqual(evaluate(DummyPath(), '1 and product all [0, nan, ""]'), False)
        self.assertEqual(evaluate(DummyPath(), '1.5 product all and [true, true]'), True)
        self.assertEqual(evaluate(DummyPath(), '1.5 and product all [true, true]'), True)
        self.assertEqual(evaluate(DummyPath(), '1.5 product all and [true, false]'), False)
        self.assertEqual(evaluate(DummyPath(), '1.5 and product all [true, false]'), False)
        self.assertEqual(evaluate(DummyPath(), '1.5 product all and [1, nan, "s", ""]'), False)
        self.assertEqual(evaluate(DummyPath(), '1.5 and product all [1, nan, "s", ""]'), False)
        self.assertEqual(evaluate(DummyPath(), '1.5 product all and [1, "s", true]'), True)
        self.assertEqual(evaluate(DummyPath(), '1.5 and product all [1, "s", true]'), True)
        self.assertEqual(evaluate(DummyPath(), '1.5 product all and [0, nan, ""]'), False)
        self.assertEqual(evaluate(DummyPath(), '1.5 and product all [0, nan, ""]'), False)
        # lhs coerces to false
        self.assertEqual(evaluate(DummyPath(), 'false product all and [true, true]'), False)
        self.assertEqual(evaluate(DummyPath(), 'false and product all [true, true]'), False)
        self.assertEqual(evaluate(DummyPath(), 'false product all and [true, false]'), False)
        self.assertEqual(evaluate(DummyPath(), 'false and product all [true, false]'), False)
        self.assertEqual(evaluate(DummyPath(), 'false product all and [1, nan, "s", ""]'), False)
        self.assertEqual(evaluate(DummyPath(), 'false and product all [1, nan, "s", ""]'), False)
        self.assertEqual(evaluate(DummyPath(), 'false product all and [1, "s", False]'), False)
        self.assertEqual(evaluate(DummyPath(), 'false and product all [1, "s", False]'), False)
        self.assertEqual(evaluate(DummyPath(), 'false product all and [0, nan, ""]'), False)
        self.assertEqual(evaluate(DummyPath(), 'false and product all [0, nan, ""]'), False)
        self.assertEqual(evaluate(DummyPath(), '"" product all and [true, true]'), False)
        self.assertEqual(evaluate(DummyPath(), '"" and product all [true, true]'), False)
        self.assertEqual(evaluate(DummyPath(), '"" product all and [true, false]'), False)
        self.assertEqual(evaluate(DummyPath(), '"" and product all [true, false]'), False)
        self.assertEqual(evaluate(DummyPath(), '"" product all and [1, nan, "s", ""]'), False)
        self.assertEqual(evaluate(DummyPath(), '"" and product all [1, nan, "s", ""]'), False)
        self.assertEqual(evaluate(DummyPath(), '"" product all and [1, "s", False]'), False)
        self.assertEqual(evaluate(DummyPath(), '"" and product all [1, "s", False]'), False)
        self.assertEqual(evaluate(DummyPath(), '"" product all and [0, nan, ""]'), False)
        self.assertEqual(evaluate(DummyPath(), '"" and product all [0, nan, ""]'), False)
        self.assertEqual(evaluate(DummyPath(), '0 product all and [true, true]'), False)
        self.assertEqual(evaluate(DummyPath(), '0 and product all [true, true]'), False)
        self.assertEqual(evaluate(DummyPath(), '0 product all and [true, false]'), False)
        self.assertEqual(evaluate(DummyPath(), '0 and product all [true, false]'), False)
        self.assertEqual(evaluate(DummyPath(), '0 product all and [1, nan, "s", ""]'), False)
        self.assertEqual(evaluate(DummyPath(), '0 and product all [1, nan, "s", ""]'), False)
        self.assertEqual(evaluate(DummyPath(), '0 product all and [1, "s", true]'), False)
        self.assertEqual(evaluate(DummyPath(), '0 and product all [1, "s", true]'), False)
        self.assertEqual(evaluate(DummyPath(), '0 product all and [0, nan, ""]'), False)
        self.assertEqual(evaluate(DummyPath(), '0 and product all [0, nan, ""]'), False)
        self.assertEqual(evaluate(DummyPath(), 'nan product all and [true, true]'), False)
        self.assertEqual(evaluate(DummyPath(), 'nan and product all [true, true]'), False)
        self.assertEqual(evaluate(DummyPath(), 'nan product all and [true, false]'), False)
        self.assertEqual(evaluate(DummyPath(), 'nan and product all [true, false]'), False)
        self.assertEqual(evaluate(DummyPath(), 'nan product all and [1, nan, "s", ""]'), False)
        self.assertEqual(evaluate(DummyPath(), 'nan and product all [1, nan, "s", ""]'), False)
        self.assertEqual(evaluate(DummyPath(), 'nan product all and [1, "s", true]'), False)
        self.assertEqual(evaluate(DummyPath(), 'nan and product all [1, "s", true]'), False)
        self.assertEqual(evaluate(DummyPath(), 'nan product all and [0, nan, ""]'), False)
        self.assertEqual(evaluate(DummyPath(), 'nan and product all [0, nan, ""]'), False)
        # empty
        self.assertEqual(evaluate(DummyPath(), 'true product all and []'), True)
        self.assertEqual(evaluate(DummyPath(), 'true and product all []'), True)
    ...
    def test_must_apply_and_seq_vs_single_using_zip_sequence(self):
        ...
        self.assertEqual(evaluate(DummyPath(), '[true, true] and zip sequence true'), [True, True])
        self.assertEqual(evaluate(DummyPath(), '[true, false] zip sequence and true'), [True, False])
        self.assertEqual(evaluate(DummyPath(), '[true, false] and zip sequence true'), [True, False])
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] zip sequence and true'), [True, False, True, False])
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] and zip sequence true'), [True, False, True, False])
        self.assertEqual(evaluate(DummyPath(), '[1, "s", true] zip sequence and true'), [True, True, True])
        self.assertEqual(evaluate(DummyPath(), '[1, "s", true] and zip sequence true'), [True, True, True])
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] zip sequence and true'), [False, False, False])
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] and zip sequence true'), [False, False, False])
        self.assertEqual(evaluate(DummyPath(), '[true, true] zip sequence and "a"'), [True, True])
        self.assertEqual(evaluate(DummyPath(), '[true, true] and zip sequence "a"'), [True, True])
        self.assertEqual(evaluate(DummyPath(), '[true, false] zip sequence and "a"'), [True, False])
        self.assertEqual(evaluate(DummyPath(), '[true, false] and zip sequence "a"'), [True, False])
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] zip sequence and "a"'), [True, False, True, False])
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] and zip sequence "a"'), [True, False, True, False])
        self.assertEqual(evaluate(DummyPath(), '[1, "s", true] zip sequence and "a"'), [True, True, True])
        self.assertEqual(evaluate(DummyPath(), '[1, "s", true] and zip sequence "a"'), [True, True, True])
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] zip sequence and "a"'), [False, False, False])
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] and zip sequence "a"'), [False, False, False])
        self.assertEqual(evaluate(DummyPath(), '[true, true] zip sequence and 1'), [True, True])
        self.assertEqual(evaluate(DummyPath(), '[true, true] and zip sequence 1'), [True, True])
        self.assertEqual(evaluate(DummyPath(), '[true, false] zip sequence and 1'), [True, False])
        self.assertEqual(evaluate(DummyPath(), '[true, false] and zip sequence 1'), [True, False])
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] zip sequence and 1'), [True, False, True, False])
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] and zip sequence 1'), [True, False, True, False])
        self.assertEqual(evaluate(DummyPath(), '[1, "s", true] zip sequence and 1'), [True, True, True])
        self.assertEqual(evaluate(DummyPath(), '[1, "s", true] and zip sequence 1'), [True, True, True])
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] zip sequence and 1'), [False, False, False])
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] and zip sequence 1'), [False, False, False])
        self.assertEqual(evaluate(DummyPath(), '[true, true] zip sequence and 1.5'), [True, True])
        self.assertEqual(evaluate(DummyPath(), '[true, true] and zip sequence 1.5'), [True, True])
        self.assertEqual(evaluate(DummyPath(), '[true, false] zip sequence and 1.5'), [True, False])
        self.assertEqual(evaluate(DummyPath(), '[true, false] and zip sequence 1.5'), [True, False])
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] zip sequence and 1.5'), [True, False, True, False])
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] and zip sequence 1.5'), [True, False, True, False])
        self.assertEqual(evaluate(DummyPath(), '[1, "s", true] zip sequence and 1.5'), [True, True, True])
        self.assertEqual(evaluate(DummyPath(), '[1, "s", true] and zip sequence 1.5'), [True, True, True])
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] zip sequence and 1.5'), [False, False, False])
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] and zip sequence 1.5'), [False, False, False])
        # lhs coerces to false
        self.assertEqual(evaluate(DummyPath(), '[true, true] zip sequence and false'), [False, False])
        self.assertEqual(evaluate(DummyPath(), '[true, true] and zip sequence false'), [False, False])
        self.assertEqual(evaluate(DummyPath(), '[true, false] zip sequence and false'), [False, False])
        self.assertEqual(evaluate(DummyPath(), '[true, false] and zip sequence false'), [False, False])
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] zip sequence and false'), [False, False, False, False])
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] and zip sequence false'), [False, False, False, False])
        self.assertEqual(evaluate(DummyPath(), '[1, "s", False] zip sequence and false'), [False, False, False])
        self.assertEqual(evaluate(DummyPath(), '[1, "s", False] and zip sequence false'), [False, False, False])
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] zip sequence and false'), [False, False, False])
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] and zip sequence false'), [False, False, False])
        self.assertEqual(evaluate(DummyPath(), '[true, true] zip sequence and ""'), [False, False])
        self.assertEqual(evaluate(DummyPath(), '[true, true] and zip sequence ""'), [False, False])
        self.assertEqual(evaluate(DummyPath(), '[true, false] zip sequence and ""'), [False, False])
        self.assertEqual(evaluate(DummyPath(), '[true, false] and zip sequence ""'), [False, False])
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] zip sequence and ""'), [False, False, False, False])
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] and zip sequence ""'), [False, False, False, False])
        self.assertEqual(evaluate(DummyPath(), '[1, "s", False] zip sequence and ""'), [False, False, False])
        self.assertEqual(evaluate(DummyPath(), '[1, "s", False] and zip sequence ""'), [False, False, False])
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] zip sequence and ""'), [False, False, False])
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] and zip sequence ""'), [False, False, False])
        self.assertEqual(evaluate(DummyPath(), '[true, true] zip sequence and 0'), [False, False])
        self.assertEqual(evaluate(DummyPath(), '[true, true] and zip sequence 0'), [False, False])
        self.assertEqual(evaluate(DummyPath(), '[true, false] zip sequence and 0'), [False, False])
        self.assertEqual(evaluate(DummyPath(), '[true, false] and zip sequence 0'), [False, False])
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] zip sequence and 0'), [False, False, False, False])
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] and zip sequence 0'), [False, False, False, False])
        self.assertEqual(evaluate(DummyPath(), '[1, "s", true] zip sequence and 0'), [False, False, False])
        self.assertEqual(evaluate(DummyPath(), '[1, "s", true] and zip sequence 0'), [False, False, False])
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] zip sequence and 0'), [False, False, False])
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] and zip sequence 0'), [False, False, False])
        self.assertEqual(evaluate(DummyPath(), '[true, true] zip sequence and nan'), [False, False])
        self.assertEqual(evaluate(DummyPath(), '[true, true] and zip sequence nan'), [False, False])
        self.assertEqual(evaluate(DummyPath(), '[true, false] zip sequence and nan'), [False, False])
        self.assertEqual(evaluate(DummyPath(), '[true, false] and zip sequence nan'), [False, False])
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] zip sequence and nan'), [False, False, False, False])
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] and zip sequence nan'), [False, False, False, False])
        self.assertEqual(evaluate(DummyPath(), '[1, "s", true] zip sequence and nan'), [False, False, False])
        self.assertEqual(evaluate(DummyPath(), '[1, "s", true] and zip sequence nan'), [False, False, False])
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] zip sequence and nan'), [False, False, False])
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] and zip sequence nan'), [False, False, False])
        # empty
        self.assertEqual(evaluate(DummyPath(), '[] zip sequence and true'), [])
        self.assertEqual(evaluate(DummyPath(), '[] and zip sequence true'), [])
    ...
    def test_must_apply_and_seq_vs_single_using_zip_any(self):
        ...
        self.assertEqual(evaluate(DummyPath(), '[true, true] and zip any true'), True)
        self.assertEqual(evaluate(DummyPath(), '[true, false] zip any and true'), True)
        self.assertEqual(evaluate(DummyPath(), '[true, false] and zip any true'), True)
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] zip any and true'), True)
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] and zip any true'), True)
        self.assertEqual(evaluate(DummyPath(), '[1, "s", true] zip any and true'), True)
        self.assertEqual(evaluate(DummyPath(), '[1, "s", true] and zip any true'), True)
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] zip any and true'), False)
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] and zip any true'), False)
        self.assertEqual(evaluate(DummyPath(), '[true, true] zip any and "a"'), True)
        self.assertEqual(evaluate(DummyPath(), '[true, true] and zip any "a"'), True)
        self.assertEqual(evaluate(DummyPath(), '[true, false] zip any and "a"'), True)
        self.assertEqual(evaluate(DummyPath(), '[true, false] and zip any "a"'), True)
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] zip any and "a"'), True)
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] and zip any "a"'), True)
        self.assertEqual(evaluate(DummyPath(), '[1, "s", true] zip any and "a"'), True)
        self.assertEqual(evaluate(DummyPath(), '[1, "s", true] and zip any "a"'), True)
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] zip any and "a"'), False)
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] and zip any "a"'), False)
        self.assertEqual(evaluate(DummyPath(), '[true, true] zip any and 1'), True)
        self.assertEqual(evaluate(DummyPath(), '[true, true] and zip any 1'), True)
        self.assertEqual(evaluate(DummyPath(), '[true, false] zip any and 1'), True)
        self.assertEqual(evaluate(DummyPath(), '[true, false] and zip any 1'), True)
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] zip any and 1'), True)
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] and zip any 1'), True)
        self.assertEqual(evaluate(DummyPath(), '[1, "s", true] zip any and 1'), True)
        self.assertEqual(evaluate(DummyPath(), '[1, "s", true] and zip any 1'), True)
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] zip any and 1'), False)
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] and zip any 1'), False)
        self.assertEqual(evaluate(DummyPath(), '[true, true] zip any and 1.5'), True)
        self.assertEqual(evaluate(DummyPath(), '[true, true] and zip any 1.5'), True)
        self.assertEqual(evaluate(DummyPath(), '[true, false] zip any and 1.5'), True)
        self.assertEqual(evaluate(DummyPath(), '[true, false] and zip any 1.5'), True)
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] zip any and 1.5'), True)
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] and zip any 1.5'), True)
        self.assertEqual(evaluate(DummyPath(), '[1, "s", true] zip any and 1.5'), True)
        self.assertEqual(evaluate(DummyPath(), '[1, "s", true] and zip any 1.5'), True)
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] zip any and 1.5'), False)
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] and zip any 1.5'), False)
        # lhs coerces to false
        self.assertEqual(evaluate(DummyPath(), '[true, true] zip any and false'), False)
        self.assertEqual(evaluate(DummyPath(), '[true, true] and zip any false'), False)
        self.assertEqual(evaluate(DummyPath(), '[true, false] zip any and false'), False)
        self.assertEqual(evaluate(DummyPath(), '[true, false] and zip any false'), False)
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] zip any and false'), False)
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] and zip any false'), False)
        self.assertEqual(evaluate(DummyPath(), '[1, "s", False] zip any and false'), False)
        self.assertEqual(evaluate(DummyPath(), '[1, "s", False] and zip any false'), False)
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] zip any and false'), False)
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] and zip any false'), False)
        self.assertEqual(evaluate(DummyPath(), '[true, true] zip any and ""'), False)
        self.assertEqual(evaluate(DummyPath(), '[true, true] and zip any ""'), False)
        self.assertEqual(evaluate(DummyPath(), '[true, false] zip any and ""'), False)
        self.assertEqual(evaluate(DummyPath(), '[true, false] and zip any ""'), False)
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] zip any and ""'), False)
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] and zip any ""'), False)
        self.assertEqual(evaluate(DummyPath(), '[1, "s", False] zip any and ""'), False)
        self.assertEqual(evaluate(DummyPath(), '[1, "s", False] and zip any ""'), False)
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] zip any and ""'), False)
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] and zip any ""'), False)
        self.assertEqual(evaluate(DummyPath(), '[true, true] zip any and 0'), False)
        self.assertEqual(evaluate(DummyPath(), '[true, true] and zip any 0'), False)
        self.assertEqual(evaluate(DummyPath(), '[true, false] zip any and 0'), False)
        self.assertEqual(evaluate(DummyPath(), '[true, false] and zip any 0'), False)
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] zip any and 0'), False)
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] and zip any 0'), False)
        self.assertEqual(evaluate(DummyPath(), '[1, "s", true] zip any and 0'), False)
        self.assertEqual(evaluate(DummyPath(), '[1, "s", true] and zip any 0'), False)
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] zip any and 0'), False)
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] and zip any 0'), False)
        self.assertEqual(evaluate(DummyPath(), '[true, true] zip any and nan'), False)
        self.assertEqual(evaluate(DummyPath(), '[true, true] and zip any nan'), False)
        self.assertEqual(evaluate(DummyPath(), '[true, false] zip any and nan'), False)
        self.assertEqual(evaluate(DummyPath(), '[true, false] and zip any nan'), False)
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] zip any and nan'), False)
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] and zip any nan'), False)
        self.assertEqual(evaluate(DummyPath(), '[1, "s", true] zip any and nan'), False)
        self.assertEqual(evaluate(DummyPath(), '[1, "s", true] and zip any nan'), False)
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] zip any and nan'), False)
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] and zip any nan'), False)
        # empty
        self.assertEqual(evaluate(DummyPath(), '[] zip any and true'), False)
        self.assertEqual(evaluate(DummyPath(), '[] and zip any true'), False)
    ...
    def test_must_apply_and_seq_vs_single_using_zip_all(self):
        ...
        self.assertEqual(evaluate(DummyPath(), '[true, true] and zip all true'), True)
        self.assertEqual(evaluate(DummyPath(), '[true, false] zip all and true'), False)
        self.assertEqual(evaluate(DummyPath(), '[true, false] and zip all true'), False)
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] zip all and true'), False)
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] and zip all true'), False)
        self.assertEqual(evaluate(DummyPath(), '[1, "s", true] zip all and true'), True)
        self.assertEqual(evaluate(DummyPath(), '[1, "s", true] and zip all true'), True)
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] zip all and true'), False)
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] and zip all true'), False)
        self.assertEqual(evaluate(DummyPath(), '[true, true] zip all and "a"'), True)
        self.assertEqual(evaluate(DummyPath(), '[true, true] and zip all "a"'), True)
        self.assertEqual(evaluate(DummyPath(), '[true, false] zip all and "a"'), False)
        self.assertEqual(evaluate(DummyPath(), '[true, false] and zip all "a"'), False)
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] zip all and "a"'), False)
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] and zip all "a"'), False)
        self.assertEqual(evaluate(DummyPath(), '[1, "s", true] zip all and "a"'), True)
        self.assertEqual(evaluate(DummyPath(), '[1, "s", true] and zip all "a"'), True)
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] zip all and "a"'), False)
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] and zip all "a"'), False)
        self.assertEqual(evaluate(DummyPath(), '[true, true] zip all and 1'), True)
        self.assertEqual(evaluate(DummyPath(), '[true, true] and zip all 1'), True)
        self.assertEqual(evaluate(DummyPath(), '[true, false] zip all and 1'), False)
        self.assertEqual(evaluate(DummyPath(), '[true, false] and zip all 1'), False)
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] zip all and 1'), False)
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] and zip all 1'), False)
        self.assertEqual(evaluate(DummyPath(), '[1, "s", true] zip all and 1'), True)
        self.assertEqual(evaluate(DummyPath(), '[1, "s", true] and zip all 1'), True)
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] zip all and 1'), False)
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] and zip all 1'), False)
        self.assertEqual(evaluate(DummyPath(), '[true, true] zip all and 1.5'), True)
        self.assertEqual(evaluate(DummyPath(), '[true, true] and zip all 1.5'), True)
        self.assertEqual(evaluate(DummyPath(), '[true, false] zip all and 1.5'), False)
        self.assertEqual(evaluate(DummyPath(), '[true, false] and zip all 1.5'), False)
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] zip all and 1.5'), False)
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] and zip all 1.5'), False)
        self.assertEqual(evaluate(DummyPath(), '[1, "s", true] zip all and 1.5'), True)
        self.assertEqual(evaluate(DummyPath(), '[1, "s", true] and zip all 1.5'), True)
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] zip all and 1.5'), False)
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] and zip all 1.5'), False)
        # lhs coerces to false
        self.assertEqual(evaluate(DummyPath(), '[true, true] zip all and false'), False)
        self.assertEqual(evaluate(DummyPath(), '[true, true] and zip all false'), False)
        self.assertEqual(evaluate(DummyPath(), '[true, false] zip all and false'), False)
        self.assertEqual(evaluate(DummyPath(), '[true, false] and zip all false'), False)
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] zip all and false'), False)
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] and zip all false'), False)
        self.assertEqual(evaluate(DummyPath(), '[1, "s", False] zip all and false'), False)
        self.assertEqual(evaluate(DummyPath(), '[1, "s", False] and zip all false'), False)
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] zip all and false'), False)
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] and zip all false'), False)
        self.assertEqual(evaluate(DummyPath(), '[true, true] zip all and ""'), False)
        self.assertEqual(evaluate(DummyPath(), '[true, true] and zip all ""'), False)
        self.assertEqual(evaluate(DummyPath(), '[true, false] zip all and ""'), False)
        self.assertEqual(evaluate(DummyPath(), '[true, false] and zip all ""'), False)
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] zip all and ""'), False)
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] and zip all ""'), False)
        self.assertEqual(evaluate(DummyPath(), '[1, "s", False] zip all and ""'), False)
        self.assertEqual(evaluate(DummyPath(), '[1, "s", False] and zip all ""'), False)
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] zip all and ""'), False)
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] and zip all ""'), False)
        self.assertEqual(evaluate(DummyPath(), '[true, true] zip all and 0'), False)
        self.assertEqual(evaluate(DummyPath(), '[true, true] and zip all 0'), False)
        self.assertEqual(evaluate(DummyPath(), '[true, false] zip all and 0'), False)
        self.assertEqual(evaluate(DummyPath(), '[true, false] and zip all 0'), False)
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] zip all and 0'), False)
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] and zip all 0'), False)
        self.assertEqual(evaluate(DummyPath(), '[1, "s", true] zip all and 0'), False)
        self.assertEqual(evaluate(DummyPath(), '[1, "s", true] and zip all 0'), False)
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] zip all and 0'), False)
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] and zip all 0'), False)
        self.assertEqual(evaluate(DummyPath(), '[true, true] zip all and nan'), False)
        self.assertEqual(evaluate(DummyPath(), '[true, true] and zip all nan'), False)
        self.assertEqual(evaluate(DummyPath(), '[true, false] zip all and nan'), False)
        self.assertEqual(evaluate(DummyPath(), '[true, false] and zip all nan'), False)
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] zip all and nan'), False)
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] and zip all nan'), False)
        self.assertEqual(evaluate(DummyPath(), '[1, "s", true] zip all and nan'), False)
        self.assertEqual(evaluate(DummyPath(), '[1, "s", true] and zip all nan'), False)
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] zip all and nan'), False)
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] and zip all nan'), False)
        # empty
        self.assertEqual(evaluate(DummyPath(), '[] zip all and true'), True)
        self.assertEqual(evaluate(DummyPath(), '[] and zip all true'), True)
    ...
    def test_must_apply_and_seq_vs_single_using_product_sequence(self):
        ...
        self.assertEqual(evaluate(DummyPath(), '[true, true] and product sequence true'), [True, True])
        self.assertEqual(evaluate(DummyPath(), '[true, false] product sequence and true'), [True, False])
        self.assertEqual(evaluate(DummyPath(), '[true, false] and product sequence true'), [True, False])
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] product sequence and true'), [True, False, True, False])
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] and product sequence true'), [True, False, True, False])
        self.assertEqual(evaluate(DummyPath(), '[1, "s", true] product sequence and true'), [True, True, True])
        self.assertEqual(evaluate(DummyPath(), '[1, "s", true] and product sequence true'), [True, True, True])
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] product sequence and true'), [False, False, False])
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] and product sequence true'), [False, False, False])
        self.assertEqual(evaluate(DummyPath(), '[true, true] product sequence and "a"'), [True, True])
        self.assertEqual(evaluate(DummyPath(), '[true, true] and product sequence "a"'), [True, True])
        self.assertEqual(evaluate(DummyPath(), '[true, false] product sequence and "a"'), [True, False])
        self.assertEqual(evaluate(DummyPath(), '[true, false] and product sequence "a"'), [True, False])
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] product sequence and "a"'), [True, False, True, False])
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] and product sequence "a"'), [True, False, True, False])
        self.assertEqual(evaluate(DummyPath(), '[1, "s", true] product sequence and "a"'), [True, True, True])
        self.assertEqual(evaluate(DummyPath(), '[1, "s", true] and product sequence "a"'), [True, True, True])
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] product sequence and "a"'), [False, False, False])
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] and product sequence "a"'), [False, False, False])
        self.assertEqual(evaluate(DummyPath(), '[true, true] product sequence and 1'), [True, True])
        self.assertEqual(evaluate(DummyPath(), '[true, true] and product sequence 1'), [True, True])
        self.assertEqual(evaluate(DummyPath(), '[true, false] product sequence and 1'), [True, False])
        self.assertEqual(evaluate(DummyPath(), '[true, false] and product sequence 1'), [True, False])
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] product sequence and 1'), [True, False, True, False])
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] and product sequence 1'), [True, False, True, False])
        self.assertEqual(evaluate(DummyPath(), '[1, "s", true] product sequence and 1'), [True, True, True])
        self.assertEqual(evaluate(DummyPath(), '[1, "s", true] and product sequence 1'), [True, True, True])
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] product sequence and 1'), [False, False, False])
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] and product sequence 1'), [False, False, False])
        self.assertEqual(evaluate(DummyPath(), '[true, true] product sequence and 1.5'), [True, True])
        self.assertEqual(evaluate(DummyPath(), '[true, true] and product sequence 1.5'), [True, True])
        self.assertEqual(evaluate(DummyPath(), '[true, false] product sequence and 1.5'), [True, False])
        self.assertEqual(evaluate(DummyPath(), '[true, false] and product sequence 1.5'), [True, False])
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] product sequence and 1.5'), [True, False, True, False])
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] and product sequence 1.5'), [True, False, True, False])
        self.assertEqual(evaluate(DummyPath(), '[1, "s", true] product sequence and 1.5'), [True, True, True])
        self.assertEqual(evaluate(DummyPath(), '[1, "s", true] and product sequence 1.5'), [True, True, True])
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] product sequence and 1.5'), [False, False, False])
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] and product sequence 1.5'), [False, False, False])
        # lhs coerces to false
        self.assertEqual(evaluate(DummyPath(), '[true, true] product sequence and false'), [False, False])
        self.assertEqual(evaluate(DummyPath(), '[true, true] and product sequence false'), [False, False])
        self.assertEqual(evaluate(DummyPath(), '[true, false] product sequence and false'), [False, False])
        self.assertEqual(evaluate(DummyPath(), '[true, false] and product sequence false'), [False, False])
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] product sequence and false'), [False, False, False, False])
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] and product sequence false'), [False, False, False, False])
        self.assertEqual(evaluate(DummyPath(), '[1, "s", False] product sequence and false'), [False, False, False])
        self.assertEqual(evaluate(DummyPath(), '[1, "s", False] and product sequence false'), [False, False, False])
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] product sequence and false'), [False, False, False])
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] and product sequence false'), [False, False, False])
        self.assertEqual(evaluate(DummyPath(), '[true, true] product sequence and ""'), [False, False])
        self.assertEqual(evaluate(DummyPath(), '[true, true] and product sequence ""'), [False, False])
        self.assertEqual(evaluate(DummyPath(), '[true, false] product sequence and ""'), [False, False])
        self.assertEqual(evaluate(DummyPath(), '[true, false] and product sequence ""'), [False, False])
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] product sequence and ""'), [False, False, False, False])
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] and product sequence ""'), [False, False, False, False])
        self.assertEqual(evaluate(DummyPath(), '[1, "s", False] product sequence and ""'), [False, False, False])
        self.assertEqual(evaluate(DummyPath(), '[1, "s", False] and product sequence ""'), [False, False, False])
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] product sequence and ""'), [False, False, False])
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] and product sequence ""'), [False, False, False])
        self.assertEqual(evaluate(DummyPath(), '[true, true] product sequence and 0'), [False, False])
        self.assertEqual(evaluate(DummyPath(), '[true, true] and product sequence 0'), [False, False])
        self.assertEqual(evaluate(DummyPath(), '[true, false] product sequence and 0'), [False, False])
        self.assertEqual(evaluate(DummyPath(), '[true, false] and product sequence 0'), [False, False])
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] product sequence and 0'), [False, False, False, False])
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] and product sequence 0'), [False, False, False, False])
        self.assertEqual(evaluate(DummyPath(), '[1, "s", true] product sequence and 0'), [False, False, False])
        self.assertEqual(evaluate(DummyPath(), '[1, "s", true] and product sequence 0'), [False, False, False])
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] product sequence and 0'), [False, False, False])
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] and product sequence 0'), [False, False, False])
        self.assertEqual(evaluate(DummyPath(), '[true, true] product sequence and nan'), [False, False])
        self.assertEqual(evaluate(DummyPath(), '[true, true] and product sequence nan'), [False, False])
        self.assertEqual(evaluate(DummyPath(), '[true, false] product sequence and nan'), [False, False])
        self.assertEqual(evaluate(DummyPath(), '[true, false] and product sequence nan'), [False, False])
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] product sequence and nan'), [False, False, False, False])
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] and product sequence nan'), [False, False, False, False])
        self.assertEqual(evaluate(DummyPath(), '[1, "s", true] product sequence and nan'), [False, False, False])
        self.assertEqual(evaluate(DummyPath(), '[1, "s", true] and product sequence nan'), [False, False, False])
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] product sequence and nan'), [False, False, False])
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] and product sequence nan'), [False, False, False])
        # empty
        self.assertEqual(evaluate(DummyPath(), '[] product sequence and true'), [])
        self.assertEqual(evaluate(DummyPath(), '[] and product sequence true'), [])
    ...
    def test_must_apply_and_seq_vs_single_using_product_any(self):
        ...
        self.assertEqual(evaluate(DummyPath(), '[true, true] and product any true'), True)
        self.assertEqual(evaluate(DummyPath(), '[true, false] product any and true'), True)
        self.assertEqual(evaluate(DummyPath(), '[true, false] and product any true'), True)
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] product any and true'), True)
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] and product any true'), True)
        self.assertEqual(evaluate(DummyPath(), '[1, "s", true] product any and true'), True)
        self.assertEqual(evaluate(DummyPath(), '[1, "s", true] and product any true'), True)
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] product any and true'), False)
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] and product any true'), False)
        self.assertEqual(evaluate(DummyPath(), '[true, true] product any and "a"'), True)
        self.assertEqual(evaluate(DummyPath(), '[true, true] and product any "a"'), True)
        self.assertEqual(evaluate(DummyPath(), '[true, false] product any and "a"'), True)
        self.assertEqual(evaluate(DummyPath(), '[true, false] and product any "a"'), True)
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] product any and "a"'), True)
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] and product any "a"'), True)
        self.assertEqual(evaluate(DummyPath(), '[1, "s", true] product any and "a"'), True)
        self.assertEqual(evaluate(DummyPath(), '[1, "s", true] and product any "a"'), True)
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] product any and "a"'), False)
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] and product any "a"'), False)
        self.assertEqual(evaluate(DummyPath(), '[true, true] product any and 1'), True)
        self.assertEqual(evaluate(DummyPath(), '[true, true] and product any 1'), True)
        self.assertEqual(evaluate(DummyPath(), '[true, false] product any and 1'), True)
        self.assertEqual(evaluate(DummyPath(), '[true, false] and product any 1'), True)
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] product any and 1'), True)
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] and product any 1'), True)
        self.assertEqual(evaluate(DummyPath(), '[1, "s", true] product any and 1'), True)
        self.assertEqual(evaluate(DummyPath(), '[1, "s", true] and product any 1'), True)
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] product any and 1'), False)
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] and product any 1'), False)
        self.assertEqual(evaluate(DummyPath(), '[true, true] product any and 1.5'), True)
        self.assertEqual(evaluate(DummyPath(), '[true, true] and product any 1.5'), True)
        self.assertEqual(evaluate(DummyPath(), '[true, false] product any and 1.5'), True)
        self.assertEqual(evaluate(DummyPath(), '[true, false] and product any 1.5'), True)
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] product any and 1.5'), True)
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] and product any 1.5'), True)
        self.assertEqual(evaluate(DummyPath(), '[1, "s", true] product any and 1.5'), True)
        self.assertEqual(evaluate(DummyPath(), '[1, "s", true] and product any 1.5'), True)
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] product any and 1.5'), False)
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] and product any 1.5'), False)
        # lhs coerces to false
        self.assertEqual(evaluate(DummyPath(), '[true, true] product any and false'), False)
        self.assertEqual(evaluate(DummyPath(), '[true, true] and product any false'), False)
        self.assertEqual(evaluate(DummyPath(), '[true, false] product any and false'), False)
        self.assertEqual(evaluate(DummyPath(), '[true, false] and product any false'), False)
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] product any and false'), False)
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] and product any false'), False)
        self.assertEqual(evaluate(DummyPath(), '[1, "s", False] product any and false'), False)
        self.assertEqual(evaluate(DummyPath(), '[1, "s", False] and product any false'), False)
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] product any and false'), False)
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] and product any false'), False)
        self.assertEqual(evaluate(DummyPath(), '[true, true] product any and ""'), False)
        self.assertEqual(evaluate(DummyPath(), '[true, true] and product any ""'), False)
        self.assertEqual(evaluate(DummyPath(), '[true, false] product any and ""'), False)
        self.assertEqual(evaluate(DummyPath(), '[true, false] and product any ""'), False)
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] product any and ""'), False)
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] and product any ""'), False)
        self.assertEqual(evaluate(DummyPath(), '[1, "s", False] product any and ""'), False)
        self.assertEqual(evaluate(DummyPath(), '[1, "s", False] and product any ""'), False)
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] product any and ""'), False)
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] and product any ""'), False)
        self.assertEqual(evaluate(DummyPath(), '[true, true] product any and 0'), False)
        self.assertEqual(evaluate(DummyPath(), '[true, true] and product any 0'), False)
        self.assertEqual(evaluate(DummyPath(), '[true, false] product any and 0'), False)
        self.assertEqual(evaluate(DummyPath(), '[true, false] and product any 0'), False)
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] product any and 0'), False)
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] and product any 0'), False)
        self.assertEqual(evaluate(DummyPath(), '[1, "s", true] product any and 0'), False)
        self.assertEqual(evaluate(DummyPath(), '[1, "s", true] and product any 0'), False)
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] product any and 0'), False)
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] and product any 0'), False)
        self.assertEqual(evaluate(DummyPath(), '[true, true] product any and nan'), False)
        self.assertEqual(evaluate(DummyPath(), '[true, true] and product any nan'), False)
        self.assertEqual(evaluate(DummyPath(), '[true, false] product any and nan'), False)
        self.assertEqual(evaluate(DummyPath(), '[true, false] and product any nan'), False)
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] product any and nan'), False)
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] and product any nan'), False)
        self.assertEqual(evaluate(DummyPath(), '[1, "s", true] product any and nan'), False)
        self.assertEqual(evaluate(DummyPath(), '[1, "s", true] and product any nan'), False)
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] product any and nan'), False)
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] and product any nan'), False)
        # empty
        self.assertEqual(evaluate(DummyPath(), '[] product any and true'), False)
        self.assertEqual(evaluate(DummyPath(), '[] and product any true'), False)
    ...
    def test_must_apply_and_seq_vs_single_using_product_all(self):
        ...
        self.assertEqual(evaluate(DummyPath(), '[true, true] and product all true'), True)
        self.assertEqual(evaluate(DummyPath(), '[true, false] product all and true'), False)
        self.assertEqual(evaluate(DummyPath(), '[true, false] and product all true'), False)
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] product all and true'), False)
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] and product all true'), False)
        self.assertEqual(evaluate(DummyPath(), '[1, "s", true] product all and true'), True)
        self.assertEqual(evaluate(DummyPath(), '[1, "s", true] and product all true'), True)
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] product all and true'), False)
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] and product all true'), False)
        self.assertEqual(evaluate(DummyPath(), '[true, true] product all and "a"'), True)
        self.assertEqual(evaluate(DummyPath(), '[true, true] and product all "a"'), True)
        self.assertEqual(evaluate(DummyPath(), '[true, false] product all and "a"'), False)
        self.assertEqual(evaluate(DummyPath(), '[true, false] and product all "a"'), False)
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] product all and "a"'), False)
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] and product all "a"'), False)
        self.assertEqual(evaluate(DummyPath(), '[1, "s", true] product all and "a"'), True)
        self.assertEqual(evaluate(DummyPath(), '[1, "s", true] and product all "a"'), True)
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] product all and "a"'), False)
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] and product all "a"'), False)
        self.assertEqual(evaluate(DummyPath(), '[true, true] product all and 1'), True)
        self.assertEqual(evaluate(DummyPath(), '[true, true] and product all 1'), True)
        self.assertEqual(evaluate(DummyPath(), '[true, false] product all and 1'), False)
        self.assertEqual(evaluate(DummyPath(), '[true, false] and product all 1'), False)
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] product all and 1'), False)
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] and product all 1'), False)
        self.assertEqual(evaluate(DummyPath(), '[1, "s", true] product all and 1'), True)
        self.assertEqual(evaluate(DummyPath(), '[1, "s", true] and product all 1'), True)
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] product all and 1'), False)
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] and product all 1'), False)
        self.assertEqual(evaluate(DummyPath(), '[true, true] product all and 1.5'), True)
        self.assertEqual(evaluate(DummyPath(), '[true, true] and product all 1.5'), True)
        self.assertEqual(evaluate(DummyPath(), '[true, false] product all and 1.5'), False)
        self.assertEqual(evaluate(DummyPath(), '[true, false] and product all 1.5'), False)
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] product all and 1.5'), False)
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] and product all 1.5'), False)
        self.assertEqual(evaluate(DummyPath(), '[1, "s", true] product all and 1.5'), True)
        self.assertEqual(evaluate(DummyPath(), '[1, "s", true] and product all 1.5'), True)
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] product all and 1.5'), False)
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] and product all 1.5'), False)
        # lhs coerces to false
        self.assertEqual(evaluate(DummyPath(), '[true, true] product all and false'), False)
        self.assertEqual(evaluate(DummyPath(), '[true, true] and product all false'), False)
        self.assertEqual(evaluate(DummyPath(), '[true, false] product all and false'), False)
        self.assertEqual(evaluate(DummyPath(), '[true, false] and product all false'), False)
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] product all and false'), False)
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] and product all false'), False)
        self.assertEqual(evaluate(DummyPath(), '[1, "s", False] product all and false'), False)
        self.assertEqual(evaluate(DummyPath(), '[1, "s", False] and product all false'), False)
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] product all and false'), False)
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] and product all false'), False)
        self.assertEqual(evaluate(DummyPath(), '[true, true] product all and ""'), False)
        self.assertEqual(evaluate(DummyPath(), '[true, true] and product all ""'), False)
        self.assertEqual(evaluate(DummyPath(), '[true, false] product all and ""'), False)
        self.assertEqual(evaluate(DummyPath(), '[true, false] and product all ""'), False)
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] product all and ""'), False)
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] and product all ""'), False)
        self.assertEqual(evaluate(DummyPath(), '[1, "s", False] product all and ""'), False)
        self.assertEqual(evaluate(DummyPath(), '[1, "s", False] and product all ""'), False)
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] product all and ""'), False)
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] and product all ""'), False)
        self.assertEqual(evaluate(DummyPath(), '[true, true] product all and 0'), False)
        self.assertEqual(evaluate(DummyPath(), '[true, true] and product all 0'), False)
        self.assertEqual(evaluate(DummyPath(), '[true, false] product all and 0'), False)
        self.assertEqual(evaluate(DummyPath(), '[true, false] and product all 0'), False)
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] product all and 0'), False)
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] and product all 0'), False)
        self.assertEqual(evaluate(DummyPath(), '[1, "s", true] product all and 0'), False)
        self.assertEqual(evaluate(DummyPath(), '[1, "s", true] and product all 0'), False)
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] product all and 0'), False)
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] and product all 0'), False)
        self.assertEqual(evaluate(DummyPath(), '[true, true] product all and nan'), False)
        self.assertEqual(evaluate(DummyPath(), '[true, true] and product all nan'), False)
        self.assertEqual(evaluate(DummyPath(), '[true, false] product all and nan'), False)
        self.assertEqual(evaluate(DummyPath(), '[true, false] and product all nan'), False)
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] product all and nan'), False)
        self.assertEqual(evaluate(DummyPath(), '[1, nan, "s", ""] and product all nan'), False)
        self.assertEqual(evaluate(DummyPath(), '[1, "s", true] product all and nan'), False)
        self.assertEqual(evaluate(DummyPath(), '[1, "s", true] and product all nan'), False)
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] product all and nan'), False)
        self.assertEqual(evaluate(DummyPath(), '[0, nan, ""] and product all nan'), False)
        # empty
        self.assertEqual(evaluate(DummyPath(), '[] product all and true'), True)
        self.assertEqual(evaluate(DummyPath(), '[] and product all true'), True)
    ...
    def test_must_apply_and_seq_vs_seq_using_zip_sequence(self):
        ...
        self.assertEqual(evaluate(DummyPath(), '[true, true] and zip sequence [true, true]'), [True, True])
        self.assertEqual(evaluate(DummyPath(), '[true, true] zip sequence and [true, false]'), [True, False])
        self.assertEqual(evaluate(DummyPath(), '[true, true] and zip sequence [true, false]'), [True, False])
        self.assertEqual(evaluate(DummyPath(), '[true, true] zip sequence and [1, nan, "s", ""]'), [True, False])
        self.assertEqual(evaluate(DummyPath(), '[true, true] and zip sequence [1, nan, "s", ""]'), [True, False])
        self.assertEqual(evaluate(DummyPath(), '[true, true] zip sequence and [1, "s", true]'), [True, True])
        self.assertEqual(evaluate(DummyPath(), '[true, true] and zip sequence [1, "s", true]'), [True, True])
        self.assertEqual(evaluate(DummyPath(), '[true, true] zip sequence and [0, nan, ""]'), [False, False])
        self.assertEqual(evaluate(DummyPath(), '[true, true] and zip sequence [0, nan, ""]'), [False, False])
        self.assertEqual(evaluate(DummyPath(), '["a", true] zip sequence and [true, true]'), [True, True])
        self.assertEqual(evaluate(DummyPath(), '["a", true] and zip sequence [true, true]'), [True, True])
        self.assertEqual(evaluate(DummyPath(), '["a", true] zip sequence and [true, false]'), [True, False])
        self.assertEqual(evaluate(DummyPath(), '["a", true] and zip sequence [true, false]'), [True, False])
        self.assertEqual(evaluate(DummyPath(), '["a", true] zip sequence and [1, nan, "s", ""]'), [True, False])
        self.assertEqual(evaluate(DummyPath(), '["a", true] and zip sequence [1, nan, "s", ""]'), [True, False])
        self.assertEqual(evaluate(DummyPath(), '["a", true] zip sequence and [1, "s", true]'), [True, True])
        self.assertEqual(evaluate(DummyPath(), '["a", true] and zip sequence [1, "s", true]'), [True, True])
        self.assertEqual(evaluate(DummyPath(), '["a", true] zip sequence and [0, nan, ""]'), [False, False])
        self.assertEqual(evaluate(DummyPath(), '["a", true] and zip sequence [0, nan, ""]'), [False, False])
        self.assertEqual(evaluate(DummyPath(), '[1, true] zip sequence and [true, true]'), [True, True])
        self.assertEqual(evaluate(DummyPath(), '[1, true] and zip sequence [true, true]'), [True, True])
        self.assertEqual(evaluate(DummyPath(), '[1, true] zip sequence and [true, false]'), [True, False])
        self.assertEqual(evaluate(DummyPath(), '[1, true] and zip sequence [true, false]'), [True, False])
        self.assertEqual(evaluate(DummyPath(), '[1, true] zip sequence and [1, nan, "s", ""]'), [True, False])
        self.assertEqual(evaluate(DummyPath(), '[1, true] and zip sequence [1, nan, "s", ""]'), [True, False])
        self.assertEqual(evaluate(DummyPath(), '[1, true] zip sequence and [1, "s", true]'), [True, True])
        self.assertEqual(evaluate(DummyPath(), '[1, true] and zip sequence [1, "s", true]'), [True, True])
        self.assertEqual(evaluate(DummyPath(), '[1, true] zip sequence and [0, nan, ""]'), [False, False])
        self.assertEqual(evaluate(DummyPath(), '[1, true] and zip sequence [0, nan, ""]'), [False, False])
        self.assertEqual(evaluate(DummyPath(), '[1.5, true] zip sequence and [true, true]'), [True, True])
        self.assertEqual(evaluate(DummyPath(), '[1.5, true] and zip sequence [true, true]'), [True, True])
        self.assertEqual(evaluate(DummyPath(), '[1.5, true] zip sequence and [true, false]'), [True, False])
        self.assertEqual(evaluate(DummyPath(), '[1.5, true] and zip sequence [true, false]'), [True, False])
        self.assertEqual(evaluate(DummyPath(), '[1.5, true] zip sequence and [1, nan, "s", ""]'), [True, False])
        self.assertEqual(evaluate(DummyPath(), '[1.5, true] and zip sequence [1, nan, "s", ""]'), [True, False])
        self.assertEqual(evaluate(DummyPath(), '[1.5, true] zip sequence and [1, "s", true]'), [True, True])
        self.assertEqual(evaluate(DummyPath(), '[1.5, true] and zip sequence [1, "s", true]'), [True, True])
        self.assertEqual(evaluate(DummyPath(), '[1.5, true] zip sequence and [0, nan, ""]'), [False, False])
        self.assertEqual(evaluate(DummyPath(), '[1.5, true] and zip sequence [0, nan, ""]'), [False, False])
        # lhs coerces to false
        self.assertEqual(evaluate(DummyPath(), '[false, true] zip sequence and [true, true]'), [False, True])
        self.assertEqual(evaluate(DummyPath(), '[false, true] and zip sequence [true, true]'), [False, True])
        self.assertEqual(evaluate(DummyPath(), '[false, true] zip sequence and [true, false]'), [False, False])
        self.assertEqual(evaluate(DummyPath(), '[false, true] and zip sequence [true, false]'), [False, False])
        self.assertEqual(evaluate(DummyPath(), '[false, true] zip sequence and [1, nan, "s", ""]'), [False, False])
        self.assertEqual(evaluate(DummyPath(), '[false, true] and zip sequence [1, nan, "s", ""]'), [False, False])
        self.assertEqual(evaluate(DummyPath(), '[false, true] zip sequence and [1, "s", False]'), [False, True])
        self.assertEqual(evaluate(DummyPath(), '[false, true] and zip sequence [1, "s", False]'), [False, True])
        self.assertEqual(evaluate(DummyPath(), '[false, true] zip sequence and [0, nan, ""]'), [False, False])
        self.assertEqual(evaluate(DummyPath(), '[false, true] and zip sequence [0, nan, ""]'), [False, False])
        self.assertEqual(evaluate(DummyPath(), '["", true] zip sequence and [true, true]'), [False, True])
        self.assertEqual(evaluate(DummyPath(), '["", true] and zip sequence [true, true]'), [False, True])
        self.assertEqual(evaluate(DummyPath(), '["", true] zip sequence and [true, false]'), [False, False])
        self.assertEqual(evaluate(DummyPath(), '["", true] and zip sequence [true, false]'), [False, False])
        self.assertEqual(evaluate(DummyPath(), '["", true] zip sequence and [1, nan, "s", ""]'), [False, False])
        self.assertEqual(evaluate(DummyPath(), '["", true] and zip sequence [1, nan, "s", ""]'), [False, False])
        self.assertEqual(evaluate(DummyPath(), '["", true] zip sequence and [1, "s", False]'), [False, True])
        self.assertEqual(evaluate(DummyPath(), '["", true] and zip sequence [1, "s", False]'), [False, True])
        self.assertEqual(evaluate(DummyPath(), '["", true] zip sequence and [0, nan, ""]'), [False, False])
        self.assertEqual(evaluate(DummyPath(), '["", true] and zip sequence [0, nan, ""]'), [False, False])
        self.assertEqual(evaluate(DummyPath(), '[0, true] zip sequence and [true, true]'), [False, True])
        self.assertEqual(evaluate(DummyPath(), '[0, true] and zip sequence [true, true]'), [False, True])
        self.assertEqual(evaluate(DummyPath(), '[0, true] zip sequence and [true, false]'), [False, False])
        self.assertEqual(evaluate(DummyPath(), '[0, true] and zip sequence [true, false]'), [False, False])
        self.assertEqual(evaluate(DummyPath(), '[0, true] zip sequence and [1, nan, "s", ""]'), [False, False])
        self.assertEqual(evaluate(DummyPath(), '[0, true] and zip sequence [1, nan, "s", ""]'), [False, False])
        self.assertEqual(evaluate(DummyPath(), '[0, true] zip sequence and [1, "s", true]'), [False, True])
        self.assertEqual(evaluate(DummyPath(), '[0, true] and zip sequence [1, "s", true]'), [False, True])
        self.assertEqual(evaluate(DummyPath(), '[0, true] zip sequence and [0, nan, ""]'), [False, False])
        self.assertEqual(evaluate(DummyPath(), '[0, true] and zip sequence [0, nan, ""]'), [False, False])
        self.assertEqual(evaluate(DummyPath(), '[nan, true] zip sequence and [true, true]'), [False, True])
        self.assertEqual(evaluate(DummyPath(), '[nan, true] and zip sequence [true, true]'), [False, True])
        self.assertEqual(evaluate(DummyPath(), '[nan, true] zip sequence and [true, false]'), [False, False])
        self.assertEqual(evaluate(DummyPath(), '[nan, true] and zip sequence [true, false]'), [False, False])
        self.assertEqual(evaluate(DummyPath(), '[nan, true] zip sequence and [1, nan, "s", ""]'), [False, False])
        self.assertEqual(evaluate(DummyPath(), '[nan, true] and zip sequence [1, nan, "s", ""]'), [False, False])
        self.assertEqual(evaluate(DummyPath(), '[nan, true] zip sequence and [1, "s", true]'), [False, True])
        self.assertEqual(evaluate(DummyPath(), '[nan, true] and zip sequence [1, "s", true]'), [False, True])
        self.assertEqual(evaluate(DummyPath(), '[nan, true] zip sequence and [0, nan, ""]'), [False, False])
        self.assertEqual(evaluate(DummyPath(), '[nan, true] and zip sequence [0, nan, ""]'), [False, False])
        # empty
        self.assertEqual(evaluate(DummyPath(), '[true, true] zip sequence and []'), [])
        self.assertEqual(evaluate(DummyPath(), '[true, true] and zip sequence []'), [])
    ...
    def test_must_apply_and_seq_vs_seq_using_zip_any(self):
        ...
        self.assertEqual(evaluate(DummyPath(), '[true, true] and zip any [true, true]'), any([True, True]))
        self.assertEqual(evaluate(DummyPath(), '[true, true] zip any and [true, false]'), any([True, False]))
        self.assertEqual(evaluate(DummyPath(), '[true, true] and zip any [true, false]'), any([True, False]))
        self.assertEqual(evaluate(DummyPath(), '[true, true] zip any and [1, nan, "s", ""]'), any([True, False]))
        self.assertEqual(evaluate(DummyPath(), '[true, true] and zip any [1, nan, "s", ""]'), any([True, False]))
        self.assertEqual(evaluate(DummyPath(), '[true, true] zip any and [1, "s", true]'), any([True, True]))
        self.assertEqual(evaluate(DummyPath(), '[true, true] and zip any [1, "s", true]'), any([True, True]))
        self.assertEqual(evaluate(DummyPath(), '[true, true] zip any and [0, nan, ""]'), any([False, False]))
        self.assertEqual(evaluate(DummyPath(), '[true, true] and zip any [0, nan, ""]'), any([False, False]))
        self.assertEqual(evaluate(DummyPath(), '["a", true] zip any and [true, true]'), any([True, True]))
        self.assertEqual(evaluate(DummyPath(), '["a", true] and zip any [true, true]'), any([True, True]))
        self.assertEqual(evaluate(DummyPath(), '["a", true] zip any and [true, false]'), any([True, False]))
        self.assertEqual(evaluate(DummyPath(), '["a", true] and zip any [true, false]'), any([True, False]))
        self.assertEqual(evaluate(DummyPath(), '["a", true] zip any and [1, nan, "s", ""]'), any([True, False]))
        self.assertEqual(evaluate(DummyPath(), '["a", true] and zip any [1, nan, "s", ""]'), any([True, False]))
        self.assertEqual(evaluate(DummyPath(), '["a", true] zip any and [1, "s", true]'), any([True, True]))
        self.assertEqual(evaluate(DummyPath(), '["a", true] and zip any [1, "s", true]'), any([True, True]))
        self.assertEqual(evaluate(DummyPath(), '["a", true] zip any and [0, nan, ""]'), any([False, False]))
        self.assertEqual(evaluate(DummyPath(), '["a", true] and zip any [0, nan, ""]'), any([False, False]))
        self.assertEqual(evaluate(DummyPath(), '[1, true] zip any and [true, true]'), any([True, True]))
        self.assertEqual(evaluate(DummyPath(), '[1, true] and zip any [true, true]'), any([True, True]))
        self.assertEqual(evaluate(DummyPath(), '[1, true] zip any and [true, false]'), any([True, False]))
        self.assertEqual(evaluate(DummyPath(), '[1, true] and zip any [true, false]'), any([True, False]))
        self.assertEqual(evaluate(DummyPath(), '[1, true] zip any and [1, nan, "s", ""]'), any([True, False]))
        self.assertEqual(evaluate(DummyPath(), '[1, true] and zip any [1, nan, "s", ""]'), any([True, False]))
        self.assertEqual(evaluate(DummyPath(), '[1, true] zip any and [1, "s", true]'), any([True, True]))
        self.assertEqual(evaluate(DummyPath(), '[1, true] and zip any [1, "s", true]'), any([True, True]))
        self.assertEqual(evaluate(DummyPath(), '[1, true] zip any and [0, nan, ""]'), any([False, False]))
        self.assertEqual(evaluate(DummyPath(), '[1, true] and zip any [0, nan, ""]'), any([False, False]))
        self.assertEqual(evaluate(DummyPath(), '[1.5, true] zip any and [true, true]'), any([True, True]))
        self.assertEqual(evaluate(DummyPath(), '[1.5, true] and zip any [true, true]'), any([True, True]))
        self.assertEqual(evaluate(DummyPath(), '[1.5, true] zip any and [true, false]'), any([True, False]))
        self.assertEqual(evaluate(DummyPath(), '[1.5, true] and zip any [true, false]'), any([True, False]))
        self.assertEqual(evaluate(DummyPath(), '[1.5, true] zip any and [1, nan, "s", ""]'), any([True, False]))
        self.assertEqual(evaluate(DummyPath(), '[1.5, true] and zip any [1, nan, "s", ""]'), any([True, False]))
        self.assertEqual(evaluate(DummyPath(), '[1.5, true] zip any and [1, "s", true]'), any([True, True]))
        self.assertEqual(evaluate(DummyPath(), '[1.5, true] and zip any [1, "s", true]'), any([True, True]))
        self.assertEqual(evaluate(DummyPath(), '[1.5, true] zip any and [0, nan, ""]'), any([False, False]))
        self.assertEqual(evaluate(DummyPath(), '[1.5, true] and zip any [0, nan, ""]'), any([False, False]))
        # lhs coerces to false
        self.assertEqual(evaluate(DummyPath(), '[false, true] zip any and [true, true]'), any([False, True]))
        self.assertEqual(evaluate(DummyPath(), '[false, true] and zip any [true, true]'), any([False, True]))
        self.assertEqual(evaluate(DummyPath(), '[false, true] zip any and [true, false]'), any([False, False]))
        self.assertEqual(evaluate(DummyPath(), '[false, true] and zip any [true, false]'), any([False, False]))
        self.assertEqual(evaluate(DummyPath(), '[false, true] zip any and [1, nan, "s", ""]'), any([False, False]))
        self.assertEqual(evaluate(DummyPath(), '[false, true] and zip any [1, nan, "s", ""]'), any([False, False]))
        self.assertEqual(evaluate(DummyPath(), '[false, true] zip any and [1, "s", False]'), any([False, True]))
        self.assertEqual(evaluate(DummyPath(), '[false, true] and zip any [1, "s", False]'), any([False, True]))
        self.assertEqual(evaluate(DummyPath(), '[false, true] zip any and [0, nan, ""]'), any([False, False]))
        self.assertEqual(evaluate(DummyPath(), '[false, true] and zip any [0, nan, ""]'), any([False, False]))
        self.assertEqual(evaluate(DummyPath(), '["", true] zip any and [true, true]'), any([False, True]))
        self.assertEqual(evaluate(DummyPath(), '["", true] and zip any [true, true]'), any([False, True]))
        self.assertEqual(evaluate(DummyPath(), '["", true] zip any and [true, false]'), any([False, False]))
        self.assertEqual(evaluate(DummyPath(), '["", true] and zip any [true, false]'), any([False, False]))
        self.assertEqual(evaluate(DummyPath(), '["", true] zip any and [1, nan, "s", ""]'), any([False, False]))
        self.assertEqual(evaluate(DummyPath(), '["", true] and zip any [1, nan, "s", ""]'), any([False, False]))
        self.assertEqual(evaluate(DummyPath(), '["", true] zip any and [1, "s", False]'), any([False, True]))
        self.assertEqual(evaluate(DummyPath(), '["", true] and zip any [1, "s", False]'), any([False, True]))
        self.assertEqual(evaluate(DummyPath(), '["", true] zip any and [0, nan, ""]'), any([False, False]))
        self.assertEqual(evaluate(DummyPath(), '["", true] and zip any [0, nan, ""]'), any([False, False]))
        self.assertEqual(evaluate(DummyPath(), '[0, true] zip any and [true, true]'), any([False, True]))
        self.assertEqual(evaluate(DummyPath(), '[0, true] and zip any [true, true]'), any([False, True]))
        self.assertEqual(evaluate(DummyPath(), '[0, true] zip any and [true, false]'), any([False, False]))
        self.assertEqual(evaluate(DummyPath(), '[0, true] and zip any [true, false]'), any([False, False]))
        self.assertEqual(evaluate(DummyPath(), '[0, true] zip any and [1, nan, "s", ""]'), any([False, False]))
        self.assertEqual(evaluate(DummyPath(), '[0, true] and zip any [1, nan, "s", ""]'), any([False, False]))
        self.assertEqual(evaluate(DummyPath(), '[0, true] zip any and [1, "s", true]'), any([False, True]))
        self.assertEqual(evaluate(DummyPath(), '[0, true] and zip any [1, "s", true]'), any([False, True]))
        self.assertEqual(evaluate(DummyPath(), '[0, true] zip any and [0, nan, ""]'), any([False, False]))
        self.assertEqual(evaluate(DummyPath(), '[0, true] and zip any [0, nan, ""]'), any([False, False]))
        self.assertEqual(evaluate(DummyPath(), '[nan, true] zip any and [true, true]'), any([False, True]))
        self.assertEqual(evaluate(DummyPath(), '[nan, true] and zip any [true, true]'), any([False, True]))
        self.assertEqual(evaluate(DummyPath(), '[nan, true] zip any and [true, false]'), any([False, False]))
        self.assertEqual(evaluate(DummyPath(), '[nan, true] and zip any [true, false]'), any([False, False]))
        self.assertEqual(evaluate(DummyPath(), '[nan, true] zip any and [1, nan, "s", ""]'), any([False, False]))
        self.assertEqual(evaluate(DummyPath(), '[nan, true] and zip any [1, nan, "s", ""]'), any([False, False]))
        self.assertEqual(evaluate(DummyPath(), '[nan, true] zip any and [1, "s", true]'), any([False, True]))
        self.assertEqual(evaluate(DummyPath(), '[nan, true] and zip any [1, "s", true]'), any([False, True]))
        self.assertEqual(evaluate(DummyPath(), '[nan, true] zip any and [0, nan, ""]'), any([False, False]))
        self.assertEqual(evaluate(DummyPath(), '[nan, true] and zip any [0, nan, ""]'), any([False, False]))
        # empty
        self.assertEqual(evaluate(DummyPath(), '[true, true] zip any and []'), any([]))
        self.assertEqual(evaluate(DummyPath(), '[true, true] and zip any []'), any([]))
    ...
    def test_must_apply_and_seq_vs_seq_using_zip_all(self):
        ...
        self.assertEqual(evaluate(DummyPath(), '[true, true] and zip all [true, true]'), all([True, True]))
        self.assertEqual(evaluate(DummyPath(), '[true, true] zip all and [true, false]'), all([True, False]))
        self.assertEqual(evaluate(DummyPath(), '[true, true] and zip all [true, false]'), all([True, False]))
        self.assertEqual(evaluate(DummyPath(), '[true, true] zip all and [1, nan, "s", ""]'), all([True, False]))
        self.assertEqual(evaluate(DummyPath(), '[true, true] and zip all [1, nan, "s", ""]'), all([True, False]))
        self.assertEqual(evaluate(DummyPath(), '[true, true] zip all and [1, "s", true]'), all([True, True]))
        self.assertEqual(evaluate(DummyPath(), '[true, true] and zip all [1, "s", true]'), all([True, True]))
        self.assertEqual(evaluate(DummyPath(), '[true, true] zip all and [0, nan, ""]'), all([False, False]))
        self.assertEqual(evaluate(DummyPath(), '[true, true] and zip all [0, nan, ""]'), all([False, False]))
        self.assertEqual(evaluate(DummyPath(), '["a", true] zip all and [true, true]'), all([True, True]))
        self.assertEqual(evaluate(DummyPath(), '["a", true] and zip all [true, true]'), all([True, True]))
        self.assertEqual(evaluate(DummyPath(), '["a", true] zip all and [true, false]'), all([True, False]))
        self.assertEqual(evaluate(DummyPath(), '["a", true] and zip all [true, false]'), all([True, False]))
        self.assertEqual(evaluate(DummyPath(), '["a", true] zip all and [1, nan, "s", ""]'), all([True, False]))
        self.assertEqual(evaluate(DummyPath(), '["a", true] and zip all [1, nan, "s", ""]'), all([True, False]))
        self.assertEqual(evaluate(DummyPath(), '["a", true] zip all and [1, "s", true]'), all([True, True]))
        self.assertEqual(evaluate(DummyPath(), '["a", true] and zip all [1, "s", true]'), all([True, True]))
        self.assertEqual(evaluate(DummyPath(), '["a", true] zip all and [0, nan, ""]'), all([False, False]))
        self.assertEqual(evaluate(DummyPath(), '["a", true] and zip all [0, nan, ""]'), all([False, False]))
        self.assertEqual(evaluate(DummyPath(), '[1, true] zip all and [true, true]'), all([True, True]))
        self.assertEqual(evaluate(DummyPath(), '[1, true] and zip all [true, true]'), all([True, True]))
        self.assertEqual(evaluate(DummyPath(), '[1, true] zip all and [true, false]'), all([True, False]))
        self.assertEqual(evaluate(DummyPath(), '[1, true] and zip all [true, false]'), all([True, False]))
        self.assertEqual(evaluate(DummyPath(), '[1, true] zip all and [1, nan, "s", ""]'), all([True, False]))
        self.assertEqual(evaluate(DummyPath(), '[1, true] and zip all [1, nan, "s", ""]'), all([True, False]))
        self.assertEqual(evaluate(DummyPath(), '[1, true] zip all and [1, "s", true]'), all([True, True]))
        self.assertEqual(evaluate(DummyPath(), '[1, true] and zip all [1, "s", true]'), all([True, True]))
        self.assertEqual(evaluate(DummyPath(), '[1, true] zip all and [0, nan, ""]'), all([False, False]))
        self.assertEqual(evaluate(DummyPath(), '[1, true] and zip all [0, nan, ""]'), all([False, False]))
        self.assertEqual(evaluate(DummyPath(), '[1.5, true] zip all and [true, true]'), all([True, True]))
        self.assertEqual(evaluate(DummyPath(), '[1.5, true] and zip all [true, true]'), all([True, True]))
        self.assertEqual(evaluate(DummyPath(), '[1.5, true] zip all and [true, false]'), all([True, False]))
        self.assertEqual(evaluate(DummyPath(), '[1.5, true] and zip all [true, false]'), all([True, False]))
        self.assertEqual(evaluate(DummyPath(), '[1.5, true] zip all and [1, nan, "s", ""]'), all([True, False]))
        self.assertEqual(evaluate(DummyPath(), '[1.5, true] and zip all [1, nan, "s", ""]'), all([True, False]))
        self.assertEqual(evaluate(DummyPath(), '[1.5, true] zip all and [1, "s", true]'), all([True, True]))
        self.assertEqual(evaluate(DummyPath(), '[1.5, true] and zip all [1, "s", true]'), all([True, True]))
        self.assertEqual(evaluate(DummyPath(), '[1.5, true] zip all and [0, nan, ""]'), all([False, False]))
        self.assertEqual(evaluate(DummyPath(), '[1.5, true] and zip all [0, nan, ""]'), all([False, False]))
        # lhs coerces to false
        self.assertEqual(evaluate(DummyPath(), '[false, true] zip all and [true, true]'), all([False, True]))
        self.assertEqual(evaluate(DummyPath(), '[false, true] and zip all [true, true]'), all([False, True]))
        self.assertEqual(evaluate(DummyPath(), '[false, true] zip all and [true, false]'), all([False, False]))
        self.assertEqual(evaluate(DummyPath(), '[false, true] and zip all [true, false]'), all([False, False]))
        self.assertEqual(evaluate(DummyPath(), '[false, true] zip all and [1, nan, "s", ""]'), all([False, False]))
        self.assertEqual(evaluate(DummyPath(), '[false, true] and zip all [1, nan, "s", ""]'), all([False, False]))
        self.assertEqual(evaluate(DummyPath(), '[false, true] zip all and [1, "s", False]'), all([False, True]))
        self.assertEqual(evaluate(DummyPath(), '[false, true] and zip all [1, "s", False]'), all([False, True]))
        self.assertEqual(evaluate(DummyPath(), '[false, true] zip all and [0, nan, ""]'), all([False, False]))
        self.assertEqual(evaluate(DummyPath(), '[false, true] and zip all [0, nan, ""]'), all([False, False]))
        self.assertEqual(evaluate(DummyPath(), '["", true] zip all and [true, true]'), all([False, True]))
        self.assertEqual(evaluate(DummyPath(), '["", true] and zip all [true, true]'), all([False, True]))
        self.assertEqual(evaluate(DummyPath(), '["", true] zip all and [true, false]'), all([False, False]))
        self.assertEqual(evaluate(DummyPath(), '["", true] and zip all [true, false]'), all([False, False]))
        self.assertEqual(evaluate(DummyPath(), '["", true] zip all and [1, nan, "s", ""]'), all([False, False]))
        self.assertEqual(evaluate(DummyPath(), '["", true] and zip all [1, nan, "s", ""]'), all([False, False]))
        self.assertEqual(evaluate(DummyPath(), '["", true] zip all and [1, "s", False]'), all([False, True]))
        self.assertEqual(evaluate(DummyPath(), '["", true] and zip all [1, "s", False]'), all([False, True]))
        self.assertEqual(evaluate(DummyPath(), '["", true] zip all and [0, nan, ""]'), all([False, False]))
        self.assertEqual(evaluate(DummyPath(), '["", true] and zip all [0, nan, ""]'), all([False, False]))
        self.assertEqual(evaluate(DummyPath(), '[0, true] zip all and [true, true]'), all([False, True]))
        self.assertEqual(evaluate(DummyPath(), '[0, true] and zip all [true, true]'), all([False, True]))
        self.assertEqual(evaluate(DummyPath(), '[0, true] zip all and [true, false]'), all([False, False]))
        self.assertEqual(evaluate(DummyPath(), '[0, true] and zip all [true, false]'), all([False, False]))
        self.assertEqual(evaluate(DummyPath(), '[0, true] zip all and [1, nan, "s", ""]'), all([False, False]))
        self.assertEqual(evaluate(DummyPath(), '[0, true] and zip all [1, nan, "s", ""]'), all([False, False]))
        self.assertEqual(evaluate(DummyPath(), '[0, true] zip all and [1, "s", true]'), all([False, True]))
        self.assertEqual(evaluate(DummyPath(), '[0, true] and zip all [1, "s", true]'), all([False, True]))
        self.assertEqual(evaluate(DummyPath(), '[0, true] zip all and [0, nan, ""]'), all([False, False]))
        self.assertEqual(evaluate(DummyPath(), '[0, true] and zip all [0, nan, ""]'), all([False, False]))
        self.assertEqual(evaluate(DummyPath(), '[nan, true] zip all and [true, true]'), all([False, True]))
        self.assertEqual(evaluate(DummyPath(), '[nan, true] and zip all [true, true]'), all([False, True]))
        self.assertEqual(evaluate(DummyPath(), '[nan, true] zip all and [true, false]'), all([False, False]))
        self.assertEqual(evaluate(DummyPath(), '[nan, true] and zip all [true, false]'), all([False, False]))
        self.assertEqual(evaluate(DummyPath(), '[nan, true] zip all and [1, nan, "s", ""]'), all([False, False]))
        self.assertEqual(evaluate(DummyPath(), '[nan, true] and zip all [1, nan, "s", ""]'), all([False, False]))
        self.assertEqual(evaluate(DummyPath(), '[nan, true] zip all and [1, "s", true]'), all([False, True]))
        self.assertEqual(evaluate(DummyPath(), '[nan, true] and zip all [1, "s", true]'), all([False, True]))
        self.assertEqual(evaluate(DummyPath(), '[nan, true] zip all and [0, nan, ""]'), all([False, False]))
        self.assertEqual(evaluate(DummyPath(), '[nan, true] and zip all [0, nan, ""]'), all([False, False]))
        # empty
        self.assertEqual(evaluate(DummyPath(), '[true, true] zip all and []'), all([]))
        self.assertEqual(evaluate(DummyPath(), '[true, true] and zip all []'), all([]))
    ...
    def test_must_apply_and_seq_vs_seq_product_sequence(self):
        ...
        self.assertEqual(evaluate(DummyPath(), '[true, true] and product sequence [true, true]'), [True, True, True, True])
        self.assertEqual(evaluate(DummyPath(), '[true, true] product sequence and [true, false]'), [True, False, True, False])
        self.assertEqual(evaluate(DummyPath(), '[true, true] and product sequence [true, false]'), [True, False, True, False])
        self.assertEqual(evaluate(DummyPath(), '[true, true] product sequence and [1, nan, "s", ""]'), [True, False, True, False, True, False, True, False])
        self.assertEqual(evaluate(DummyPath(), '[true, true] and product sequence [1, nan, "s", ""]'), [True, False, True, False, True, False, True, False])
        self.assertEqual(evaluate(DummyPath(), '[true, true] product sequence and [1, "s", true]'), [True, True, True, True, True, True])
        self.assertEqual(evaluate(DummyPath(), '[true, true] and product sequence [1, "s", true]'), [True, True, True, True, True, True])
        self.assertEqual(evaluate(DummyPath(), '[true, true] product sequence and [0, nan, ""]'), [False, False, False, False, False, False])
        self.assertEqual(evaluate(DummyPath(), '[true, true] and product sequence [0, nan, ""]'), [False, False, False, False, False, False])
        self.assertEqual(evaluate(DummyPath(), '["a", true] product sequence and [true, true]'), [True, True, True, True])
        self.assertEqual(evaluate(DummyPath(), '["a", true] and product sequence [true, true]'), [True, True, True, True])
        self.assertEqual(evaluate(DummyPath(), '["a", true] product sequence and [true, false]'), [True, False, True, False])
        self.assertEqual(evaluate(DummyPath(), '["a", true] and product sequence [true, false]'), [True, False, True, False])
        self.assertEqual(evaluate(DummyPath(), '["a", true] product sequence and [1, nan, "s", ""]'), [True, False, True, False, True, False, True, False])
        self.assertEqual(evaluate(DummyPath(), '["a", true] and product sequence [1, nan, "s", ""]'), [True, False, True, False, True, False, True, False])
        self.assertEqual(evaluate(DummyPath(), '["a", true] product sequence and [1, "s", true]'), [True, True, True, True, True, True])
        self.assertEqual(evaluate(DummyPath(), '["a", true] and product sequence [1, "s", true]'), [True, True, True, True, True, True])
        self.assertEqual(evaluate(DummyPath(), '["a", true] product sequence and [0, nan, ""]'), [False, False, False, False, False, False])
        self.assertEqual(evaluate(DummyPath(), '["a", true] and product sequence [0, nan, ""]'), [False, False, False, False, False, False])
        self.assertEqual(evaluate(DummyPath(), '[1, true] product sequence and [true, true]'), [True, True, True, True])
        self.assertEqual(evaluate(DummyPath(), '[1, true] and product sequence [true, true]'), [True, True, True, True])
        self.assertEqual(evaluate(DummyPath(), '[1, true] product sequence and [true, false]'), [True, False, True, False])
        self.assertEqual(evaluate(DummyPath(), '[1, true] and product sequence [true, false]'), [True, False, True, False])
        self.assertEqual(evaluate(DummyPath(), '[1, true] product sequence and [1, nan, "s", ""]'), [True, False, True, False, True, False, True, False])
        self.assertEqual(evaluate(DummyPath(), '[1, true] and product sequence [1, nan, "s", ""]'), [True, False, True, False, True, False, True, False])
        self.assertEqual(evaluate(DummyPath(), '[1, true] product sequence and [1, "s", true]'), [True, True, True, True, True, True])
        self.assertEqual(evaluate(DummyPath(), '[1, true] and product sequence [1, "s", true]'), [True, True, True, True, True, True])
        self.assertEqual(evaluate(DummyPath(), '[1, true] product sequence and [0, nan, ""]'), [False, False, False, False, False, False])
        self.assertEqual(evaluate(DummyPath(), '[1, true] and product sequence [0, nan, ""]'), [False, False, False, False, False, False])
        self.assertEqual(evaluate(DummyPath(), '[1.5, true] product sequence and [true, true]'), [True, True, True, True])
        self.assertEqual(evaluate(DummyPath(), '[1.5, true] and product sequence [true, true]'), [True, True, True, True])
        self.assertEqual(evaluate(DummyPath(), '[1.5, true] product sequence and [true, false]'), [True, False, True, False])
        self.assertEqual(evaluate(DummyPath(), '[1.5, true] and product sequence [true, false]'), [True, False, True, False])
        self.assertEqual(evaluate(DummyPath(), '[1.5, true] product sequence and [1, nan, "s", ""]'), [True, False, True, False, True, False, True, False])
        self.assertEqual(evaluate(DummyPath(), '[1.5, true] and product sequence [1, nan, "s", ""]'), [True, False, True, False, True, False, True, False])
        self.assertEqual(evaluate(DummyPath(), '[1.5, true] product sequence and [1, "s", true]'), [True, True, True, True, True, True])
        self.assertEqual(evaluate(DummyPath(), '[1.5, true] and product sequence [1, "s", true]'), [True, True, True, True, True, True])
        self.assertEqual(evaluate(DummyPath(), '[1.5, true] product sequence and [0, nan, ""]'), [False, False, False, False, False, False])
        self.assertEqual(evaluate(DummyPath(), '[1.5, true] and product sequence [0, nan, ""]'), [False, False, False, False, False, False])
        # lhs coerces to false
        self.assertEqual(evaluate(DummyPath(), '[false, true] product sequence and [true, true]'), [False, False, True, True])
        self.assertEqual(evaluate(DummyPath(), '[false, true] and product sequence [true, true]'), [False, False, True, True])
        self.assertEqual(evaluate(DummyPath(), '[false, true] product sequence and [true, false]'), [False, False, True, False])
        self.assertEqual(evaluate(DummyPath(), '[false, true] and product sequence [true, false]'), [False, False, True, False])
        ...
        self.assertEqual(evaluate(DummyPath(), '[false, true] and product sequence [1, nan, "s", ""]'), [False, False, False, False, True, False, True, False])
        self.assertEqual(evaluate(DummyPath(), '[false, true] product sequence and [1, "s", False]'), [False, False, False, True, True, True])
        self.assertEqual(evaluate(DummyPath(), '[false, true] and product sequence [1, "s", False]'), [False, False, False, True, True, True])
        self.assertEqual(evaluate(DummyPath(), '[false, true] product sequence and [0, nan, ""]'), [False, False, False, False, False, False])
        self.assertEqual(evaluate(DummyPath(), '[false, true] and product sequence [0, nan, ""]'), [False, False, False, False, False, False])
        self.assertEqual(evaluate(DummyPath(), '["", true] product sequence and [true, true]'), [False, False, True, True])
        self.assertEqual(evaluate(DummyPath(), '["", true] and product sequence [true, true]'), [False, False, True, True])
        self.assertEqual(evaluate(DummyPath(), '["", true] product sequence and [true, false]'), [False, False, True, False])
        self.assertEqual(evaluate(DummyPath(), '["", true] and product sequence [true, false]'), [False, False, True, False])
        self.assertEqual(evaluate(DummyPath(), '["", true] product sequence and [1, nan, "s", ""]'), [False, False, False, False, True, False, True, False])
        self.assertEqual(evaluate(DummyPath(), '["", true] and product sequence [1, nan, "s", ""]'), [False, False, False, False, True, False, True, False])
        self.assertEqual(evaluate(DummyPath(), '["", true] product sequence and [1, "s", False]'), [False, False, False, True, True, True])
        self.assertEqual(evaluate(DummyPath(), '["", true] and product sequence [1, "s", False]'), [False, False, False, True, True, True])
        self.assertEqual(evaluate(DummyPath(), '["", true] product sequence and [0, nan, ""]'), [False, False, False, False, False, False])
        self.assertEqual(evaluate(DummyPath(), '["", true] and product sequence [0, nan, ""]'), [False, False, False, False, False, False])
        self.assertEqual(evaluate(DummyPath(), '[0, true] product sequence and [true, true]'), [False, False, True, True])
        self.assertEqual(evaluate(DummyPath(), '[0, true] and product sequence [true, true]'), [False, False, True, True])
        self.assertEqual(evaluate(DummyPath(), '[0, true] product sequence and [true, false]'), [False, False, True, False])
        self.assertEqual(evaluate(DummyPath(), '[0, true] and product sequence [true, false]'), [False, False, True, False])
        self.assertEqual(evaluate(DummyPath(), '[0, true] product sequence and [1, nan, "s", ""]'), [False, False, False, False, True, False, True, False])
        self.assertEqual(evaluate(DummyPath(), '[0, true] and product sequence [1, nan, "s", ""]'), [False, False, False, False, True, False, True, False])
        self.assertEqual(evaluate(DummyPath(), '[0, true] product sequence and [1, "s", true]'), [False, False, False, True, True, True])
        self.assertEqual(evaluate(DummyPath(), '[0, true] and product sequence [1, "s", true]'), [False, False, False, True, True, True])
        self.assertEqual(evaluate(DummyPath(), '[0, true] product sequence and [0, nan, ""]'), [False, False, False, False, False, False])
        self.assertEqual(evaluate(DummyPath(), '[0, true] and product sequence [0, nan, ""]'), [False, False, False, False, False, False])
        self.assertEqual(evaluate(DummyPath(), '[nan, true] product sequence and [true, true]'), [False, False, True, True])
        self.assertEqual(evaluate(DummyPath(), '[nan, true] and product sequence [true, true]'), [False, False, True, True])
        self.assertEqual(evaluate(DummyPath(), '[nan, true] product sequence and [true, false]'), [False, False, True, False])
        self.assertEqual(evaluate(DummyPath(), '[nan, true] and product sequence [true, false]'), [False, False, True, False])
        self.assertEqual(evaluate(DummyPath(), '[nan, true] product sequence and [1, nan, "s", ""]'), [False, False, False, False, True, False, True, False])
        self.assertEqual(evaluate(DummyPath(), '[nan, true] and product sequence [1, nan, "s", ""]'), [False, False, False, False, True, False, True, False])
        self.assertEqual(evaluate(DummyPath(), '[nan, true] product sequence and [1, "s", true]'), [False, False, False, True, True, True])
        self.assertEqual(evaluate(DummyPath(), '[nan, true] and product sequence [1, "s", true]'), [False, False, False, True, True, True])
        self.assertEqual(evaluate(DummyPath(), '[nan, true] product sequence and [0, nan, ""]'), [False, False, False, False, False, False])
        self.assertEqual(evaluate(DummyPath(), '[nan, true] and product sequence [0, nan, ""]'), [False, False, False, False, False, False])
        # empty
        self.assertEqual(evaluate(DummyPath(), '[true, true] product sequence and []'), [])
        self.assertEqual(evaluate(DummyPath(), '[true, true] and product sequence []'), [])
    ...
    def test_must_apply_and_seq_vs_seq_product_any(self):
        ...
        self.assertEqual(evaluate(DummyPath(), '[true, true] and product any [true, true]'), any([True, True, True, True]))
        self.assertEqual(evaluate(DummyPath(), '[true, true] product any and [true, false]'), any([True, False, True, False]))
        self.assertEqual(evaluate(DummyPath(), '[true, true] and product any [true, false]'), any([True, False, True, False]))
        self.assertEqual(evaluate(DummyPath(), '[true, true] product any and [1, nan, "s", ""]'), any([True, False, True, False, True, False, True, False]))
        self.assertEqual(evaluate(DummyPath(), '[true, true] and product any [1, nan, "s", ""]'), any([True, False, True, False, True, False, True, False]))
        self.assertEqual(evaluate(DummyPath(), '[true, true] product any and [1, "s", true]'), any([True, True, True, True, True, True]))
        self.assertEqual(evaluate(DummyPath(), '[true, true] and product any [1, "s", true]'), any([True, True, True, True, True, True]))
        self.assertEqual(evaluate(DummyPath(), '[true, true] product any and [0, nan, ""]'), any([False, False, False, False, False, False]))
        self.assertEqual(evaluate(DummyPath(), '[true, true] and product any [0, nan, ""]'), any([False, False, False, False, False, False]))
        self.assertEqual(evaluate(DummyPath(), '["a", true] product any and [true, true]'), any([True, True, True, True]))
        self.assertEqual(evaluate(DummyPath(), '["a", true] and product any [true, true]'), any([True, True, True, True]))
        self.assertEqual(evaluate(DummyPath(), '["a", true] product any and [true, false]'), any([True, False, True, False]))
        self.assertEqual(evaluate(DummyPath(), '["a", true] and product any [true, false]'), any([True, False, True, False]))
        self.assertEqual(evaluate(DummyPath(), '["a", true] product any and [1, nan, "s", ""]'), any([True, False, True, False, True, False, True, False]))
        self.assertEqual(evaluate(DummyPath(), '["a", true] and product any [1, nan, "s", ""]'), any([True, False, True, False, True, False, True, False]))
        self.assertEqual(evaluate(DummyPath(), '["a", true] product any and [1, "s", true]'), any([True, True, True, True, True, True]))
        self.assertEqual(evaluate(DummyPath(), '["a", true] and product any [1, "s", true]'), any([True, True, True, True, True, True]))
        self.assertEqual(evaluate(DummyPath(), '["a", true] product any and [0, nan, ""]'), any([False, False, False, False, False, False]))
        self.assertEqual(evaluate(DummyPath(), '["a", true] and product any [0, nan, ""]'), any([False, False, False, False, False, False]))
        self.assertEqual(evaluate(DummyPath(), '[1, true] product any and [true, true]'), any([True, True, True, True]))
        self.assertEqual(evaluate(DummyPath(), '[1, true] and product any [true, true]'), any([True, True, True, True]))
        self.assertEqual(evaluate(DummyPath(), '[1, true] product any and [true, false]'), any([True, False, True, False]))
        self.assertEqual(evaluate(DummyPath(), '[1, true] and product any [true, false]'), any([True, False, True, False]))
        self.assertEqual(evaluate(DummyPath(), '[1, true] product any and [1, nan, "s", ""]'), any([True, False, True, False, True, False, True, False]))
        self.assertEqual(evaluate(DummyPath(), '[1, true] and product any [1, nan, "s", ""]'), any([True, False, True, False, True, False, True, False]))
        self.assertEqual(evaluate(DummyPath(), '[1, true] product any and [1, "s", true]'), any([True, True, True, True, True, True]))
        self.assertEqual(evaluate(DummyPath(), '[1, true] and product any [1, "s", true]'), any([True, True, True, True, True, True]))
        self.assertEqual(evaluate(DummyPath(), '[1, true] product any and [0, nan, ""]'), any([False, False, False, False, False, False]))
        self.assertEqual(evaluate(DummyPath(), '[1, true] and product any [0, nan, ""]'), any([False, False, False, False, False, False]))
        self.assertEqual(evaluate(DummyPath(), '[1.5, true] product any and [true, true]'), any([True, True, True, True]))
        self.assertEqual(evaluate(DummyPath(), '[1.5, true] and product any [true, true]'), any([True, True, True, True]))
        self.assertEqual(evaluate(DummyPath(), '[1.5, true] product any and [true, false]'), any([True, False, True, False]))
        self.assertEqual(evaluate(DummyPath(), '[1.5, true] and product any [true, false]'), any([True, False, True, False]))
        self.assertEqual(evaluate(DummyPath(), '[1.5, true] product any and [1, nan, "s", ""]'), any([True, False, True, False, True, False, True, False]))
        self.assertEqual(evaluate(DummyPath(), '[1.5, true] and product any [1, nan, "s", ""]'), any([True, False, True, False, True, False, True, False]))
        self.assertEqual(evaluate(DummyPath(), '[1.5, true] product any and [1, "s", true]'), any([True, True, True, True, True, True]))
        self.assertEqual(evaluate(DummyPath(), '[1.5, true] and product any [1, "s", true]'), any([True, True, True, True, True, True]))
        self.assertEqual(evaluate(DummyPath(), '[1.5, true] product any and [0, nan, ""]'), any([False, False, False, False, False, False]))
        self.assertEqual(evaluate(DummyPath(), '[1.5, true] and product any [0, nan, ""]'), any([False, False, False, False, False, False]))
        # lhs coerces to false
        self.assertEqual(evaluate(DummyPath(), '[false, true] product any and [true, true]'), any([False, False, True, True]))
        self.assertEqual(evaluate(DummyPath(), '[false, true] and product any [true, true]'), any([False, False, True, True]))
        self.assertEqual(evaluate(DummyPath(), '[false, true] product any and [true, false]'), any([False, False, True, False]))
        self.assertEqual(evaluate(DummyPath(), '[false, true] and product any [true, false]'), any([False, False, True, False]))
        self.assertEqual(evaluate(DummyPath(), '[false, true] product any and [1, nan, "s", ""]'), any([False, False, False, False, True, False, True, False]))
        self.assertEqual(evaluate(DummyPath(), '[false, true] and product any [1, nan, "s", ""]'), any([False, False, False, False, True, False, True, False]))
        self.assertEqual(evaluate(DummyPath(), '[false, true] product any and [1, "s", False]'), any([False, False, False, True, True, True]))
        self.assertEqual(evaluate(DummyPath(), '[false, true] and product any [1, "s", False]'), any([False, False, False, True, True, True]))
        self.assertEqual(evaluate(DummyPath(), '[false, true] product any and [0, nan, ""]'), any([False, False, False, False, False, False]))
        self.assertEqual(evaluate(DummyPath(), '[false, true] and product any [0, nan, ""]'), any([False, False, False, False, False, False]))
        self.assertEqual(evaluate(DummyPath(), '["", true] product any and [true, true]'), any([False, False, True, True]))
        self.assertEqual(evaluate(DummyPath(), '["", true] and product any [true, true]'), any([False, False, True, True]))
        self.assertEqual(evaluate(DummyPath(), '["", true] product any and [true, false]'), any([False, False, True, False]))
        self.assertEqual(evaluate(DummyPath(), '["", true] and product any [true, false]'), any([False, False, True, False]))
        self.assertEqual(evaluate(DummyPath(), '["", true] product any and [1, nan, "s", ""]'), any([False, False, False, False, True, False, True, False]))
        self.assertEqual(evaluate(DummyPath(), '["", true] and product any [1, nan, "s", ""]'), any([False, False, False, False, True, False, True, False]))
        self.assertEqual(evaluate(DummyPath(), '["", true] product any and [1, "s", False]'), any([False, False, False, True, True, True]))
        self.assertEqual(evaluate(DummyPath(), '["", true] and product any [1, "s", False]'), any([False, False, False, True, True, True]))
        self.assertEqual(evaluate(DummyPath(), '["", true] product any and [0, nan, ""]'), any([False, False, False, False, False, False]))
        self.assertEqual(evaluate(DummyPath(), '["", true] and product any [0, nan, ""]'), any([False, False, False, False, False, False]))
        self.assertEqual(evaluate(DummyPath(), '[0, true] product any and [true, true]'), any([False, False, True, True]))
        self.assertEqual(evaluate(DummyPath(), '[0, true] and product any [true, true]'), any([False, False, True, True]))
        self.assertEqual(evaluate(DummyPath(), '[0, true] product any and [true, false]'), any([False, False, True, False]))
        self.assertEqual(evaluate(DummyPath(), '[0, true] and product any [true, false]'), any([False, False, True, False]))
        self.assertEqual(evaluate(DummyPath(), '[0, true] product any and [1, nan, "s", ""]'), any([False, False, False, False, True, False, True, False]))
        self.assertEqual(evaluate(DummyPath(), '[0, true] and product any [1, nan, "s", ""]'), any([False, False, False, False, True, False, True, False]))
        self.assertEqual(evaluate(DummyPath(), '[0, true] product any and [1, "s", true]'), any([False, False, False, True, True, True]))
        self.assertEqual(evaluate(DummyPath(), '[0, true] and product any [1, "s", true]'), any([False, False, False, True, True, True]))
        self.assertEqual(evaluate(DummyPath(), '[0, true] product any and [0, nan, ""]'), any([False, False, False, False, False, False]))
        self.assertEqual(evaluate(DummyPath(), '[0, true] and product any [0, nan, ""]'), any([False, False, False, False, False, False]))
        self.assertEqual(evaluate(DummyPath(), '[nan, true] product any and [true, true]'), any([False, False, True, True]))
        self.assertEqual(evaluate(DummyPath(), '[nan, true] and product any [true, true]'), any([False, False, True, True]))
        self.assertEqual(evaluate(DummyPath(), '[nan, true] product any and [true, false]'), any([False, False, True, False]))
        self.assertEqual(evaluate(DummyPath(), '[nan, true] and product any [true, false]'), any([False, False, True, False]))
        self.assertEqual(evaluate(DummyPath(), '[nan, true] product any and [1, nan, "s", ""]'), any([False, False, False, False, True, False, True, False]))
        self.assertEqual(evaluate(DummyPath(), '[nan, true] and product any [1, nan, "s", ""]'), any([False, False, False, False, True, False, True, False]))
        self.assertEqual(evaluate(DummyPath(), '[nan, true] product any and [1, "s", true]'), any([False, False, False, True, True, True]))
        self.assertEqual(evaluate(DummyPath(), '[nan, true] and product any [1, "s", true]'), any([False, False, False, True, True, True]))
        self.assertEqual(evaluate(DummyPath(), '[nan, true] product any and [0, nan, ""]'), any([False, False, False, False, False, False]))
        self.assertEqual(evaluate(DummyPath(), '[nan, true] and product any [0, nan, ""]'), any([False, False, False, False, False, False]))
        # empty
        self.assertEqual(evaluate(DummyPath(), '[true, true] product any and []'), any([]))
        self.assertEqual(evaluate(DummyPath(), '[true, true] and product any []'), any([]))
    ...
    def test_must_apply_and_seq_vs_seq_product_all(self):
        ...
        self.assertEqual(evaluate(DummyPath(), '[true, true] and product all [true, true]'), all([True, True, True, True]))
        self.assertEqual(evaluate(DummyPath(), '[true, true] product all and [true, false]'), all([True, False, True, False]))
        self.assertEqual(evaluate(DummyPath(), '[true, true] and product all [true, false]'), all([True, False, True, False]))
        self.assertEqual(evaluate(DummyPath(), '[true, true] product all and [1, nan, "s", ""]'), all([True, False, True, False, True, False, True, False]))
        self.assertEqual(evaluate(DummyPath(), '[true, true] and product all [1, nan, "s", ""]'), all([True, False, True, False, True, False, True, False]))
        self.assertEqual(evaluate(DummyPath(), '[true, true] product all and [1, "s", true]'), all([True, True, True, True, True, True]))
        self.assertEqual(evaluate(DummyPath(), '[true, true] and product all [1, "s", true]'), all([True, True, True, True, True, True]))
        self.assertEqual(evaluate(DummyPath(), '[true, true] product all and [0, nan, ""]'), all([False, False, False, False, False, False]))
        self.assertEqual(evaluate(DummyPath(), '[true, true] and product all [0, nan, ""]'), all([False, False, False, False, False, False]))
        self.assertEqual(evaluate(DummyPath(), '["a", true] product all and [true, true]'), all([True, True, True, True]))
        self.assertEqual(evaluate(DummyPath(), '["a", true] and product all [true, true]'), all([True, True, True, True]))
        self.assertEqual(evaluate(DummyPath(), '["a", true] product all and [true, false]'), all([True, False, True, False]))
        self.assertEqual(evaluate(DummyPath(), '["a", true] and product all [true, false]'), all([True, False, True, False]))
        self.assertEqual(evaluate(DummyPath(), '["a", true] product all and [1, nan, "s", ""]'), all([True, False, True, False, True, False, True, False]))
        self.assertEqual(evaluate(DummyPath(), '["a", true] and product all [1, nan, "s", ""]'), all([True, False, True, False, True, False, True, False]))
        self.assertEqual(evaluate(DummyPath(), '["a", true] product all and [1, "s", true]'), all([True, True, True, True, True, True]))
        self.assertEqual(evaluate(DummyPath(), '["a", true] and product all [1, "s", true]'), all([True, True, True, True, True, True]))
        self.assertEqual(evaluate(DummyPath(), '["a", true] product all and [0, nan, ""]'), all([False, False, False, False, False, False]))
        self.assertEqual(evaluate(DummyPath(), '["a", true] and product all [0, nan, ""]'), all([False, False, False, False, False, False]))
        self.assertEqual(evaluate(DummyPath(), '[1, true] product all and [true, true]'), all([True, True, True, True]))
        self.assertEqual(evaluate(DummyPath(), '[1, true] and product all [true, true]'), all([True, True, True, True]))
        self.assertEqual(evaluate(DummyPath(), '[1, true] product all and [true, false]'), all([True, False, True, False]))
        self.assertEqual(evaluate(DummyPath(), '[1, true] and product all [true, false]'), all([True, False, True, False]))
        self.assertEqual(evaluate(DummyPath(), '[1, true] product all and [1, nan, "s", ""]'), all([True, False, True, False, True, False, True, False]))
        self.assertEqual(evaluate(DummyPath(), '[1, true] and product all [1, nan, "s", ""]'), all([True, False, True, False, True, False, True, False]))
        self.assertEqual(evaluate(DummyPath(), '[1, true] product all and [1, "s", true]'), all([True, True, True, True, True, True]))
        self.assertEqual(evaluate(DummyPath(), '[1, true] and product all [1, "s", true]'), all([True, True, True, True, True, True]))
        self.assertEqual(evaluate(DummyPath(), '[1, true] product all and [0, nan, ""]'), all([False, False, False, False, False, False]))
        self.assertEqual(evaluate(DummyPath(), '[1, true] and product all [0, nan, ""]'), all([False, False, False, False, False, False]))
        self.assertEqual(evaluate(DummyPath(), '[1.5, true] product all and [true, true]'), all([True, True, True, True]))
        self.assertEqual(evaluate(DummyPath(), '[1.5, true] and product all [true, true]'), all([True, True, True, True]))
        self.assertEqual(evaluate(DummyPath(), '[1.5, true] product all and [true, false]'), all([True, False, True, False]))
        self.assertEqual(evaluate(DummyPath(), '[1.5, true] and product all [true, false]'), all([True, False, True, False]))
        self.assertEqual(evaluate(DummyPath(), '[1.5, true] product all and [1, nan, "s", ""]'), all([True, False, True, False, True, False, True, False]))
        self.assertEqual(evaluate(DummyPath(), '[1.5, true] and product all [1, nan, "s", ""]'), all([True, False, True, False, True, False, True, False]))
        self.assertEqual(evaluate(DummyPath(), '[1.5, true] product all and [1, "s", true]'), all([True, True, True, True, True, True]))
        self.assertEqual(evaluate(DummyPath(), '[1.5, true] and product all [1, "s", true]'), all([True, True, True, True, True, True]))
        self.assertEqual(evaluate(DummyPath(), '[1.5, true] product all and [0, nan, ""]'), all([False, False, False, False, False, False]))
        self.assertEqual(evaluate(DummyPath(), '[1.5, true] and product all [0, nan, ""]'), all([False, False, False, False, False, False]))
        # lhs coerces to false
        self.assertEqual(evaluate(DummyPath(), '[false, true] product all and [true, true]'), all([False, False, True, True]))
        self.assertEqual(evaluate(DummyPath(), '[false, true] and product all [true, true]'), all([False, False, True, True]))
        self.assertEqual(evaluate(DummyPath(), '[false, true] product all and [true, false]'), all([False, False, True, False]))
        self.assertEqual(evaluate(DummyPath(), '[false, true] and product all [true, false]'), all([False, False, True, False]))
        self.assertEqual(evaluate(DummyPath(), '[false, true] product all and [1, nan, "s", ""]'), all([False, False, False, False, True, False, True, False]))
        self.assertEqual(evaluate(DummyPath(), '[false, true] and product all [1, nan, "s", ""]'), all([False, False, False, False, True, False, True, False]))
        self.assertEqual(evaluate(DummyPath(), '[false, true] product all and [1, "s", False]'), all([False, False, False, True, True, True]))
        self.assertEqual(evaluate(DummyPath(), '[false, true] and product all [1, "s", False]'), all([False, False, False, True, True, True]))
        self.assertEqual(evaluate(DummyPath(), '[false, true] product all and [0, nan, ""]'), all([False, False, False, False, False, False]))
        self.assertEqual(evaluate(DummyPath(), '[false, true] and product all [0, nan, ""]'), all([False, False, False, False, False, False]))
        self.assertEqual(evaluate(DummyPath(), '["", true] product all and [true, true]'), all([False, False, True, True]))
        self.assertEqual(evaluate(DummyPath(), '["", true] and product all [true, true]'), all([False, False, True, True]))
        self.assertEqual(evaluate(DummyPath(), '["", true] product all and [true, false]'), all([False, False, True, False]))
        self.assertEqual(evaluate(DummyPath(), '["", true] and product all [true, false]'), all([False, False, True, False]))
        self.assertEqual(evaluate(DummyPath(), '["", true] product all and [1, nan, "s", ""]'), all([False, False, False, False, True, False, True, False]))
        self.assertEqual(evaluate(DummyPath(), '["", true] and product all [1, nan, "s", ""]'), all([False, False, False, False, True, False, True, False]))
        self.assertEqual(evaluate(DummyPath(), '["", true] product all and [1, "s", False]'), all([False, False, False, True, True, True]))
        self.assertEqual(evaluate(DummyPath(), '["", true] and product all [1, "s", False]'), all([False, False, False, True, True, True]))
        self.assertEqual(evaluate(DummyPath(), '["", true] product all and [0, nan, ""]'), all([False, False, False, False, False, False]))
        self.assertEqual(evaluate(DummyPath(), '["", true] and product all [0, nan, ""]'), all([False, False, False, False, False, False]))
        self.assertEqual(evaluate(DummyPath(), '[0, true] product all and [true, true]'), all([False, False, True, True]))
        self.assertEqual(evaluate(DummyPath(), '[0, true] and product all [true, true]'), all([False, False, True, True]))
        self.assertEqual(evaluate(DummyPath(), '[0, true] product all and [true, false]'), all([False, False, True, False]))
        self.assertEqual(evaluate(DummyPath(), '[0, true] and product all [true, false]'), all([False, False, True, False]))
        self.assertEqual(evaluate(DummyPath(), '[0, true] product all and [1, nan, "s", ""]'), all([False, False, False, False, True, False, True, False]))
        self.assertEqual(evaluate(DummyPath(), '[0, true] and product all [1, nan, "s", ""]'), all([False, False, False, False, True, False, True, False]))
        self.assertEqual(evaluate(DummyPath(), '[0, true] product all and [1, "s", true]'), all([False, False, False, True, True, True]))
        self.assertEqual(evaluate(DummyPath(), '[0, true] and product all [1, "s", true]'), all([False, False, False, True, True, True]))
        self.assertEqual(evaluate(DummyPath(), '[0, true] product all and [0, nan, ""]'), all([False, False, False, False, False, False]))
        self.assertEqual(evaluate(DummyPath(), '[0, true] and product all [0, nan, ""]'), all([False, False, False, False, False, False]))
        self.assertEqual(evaluate(DummyPath(), '[nan, true] product all and [true, true]'), all([False, False, True, True]))
        self.assertEqual(evaluate(DummyPath(), '[nan, true] and product all [true, true]'), all([False, False, True, True]))
        self.assertEqual(evaluate(DummyPath(), '[nan, true] product all and [true, false]'), all([False, False, True, False]))
        self.assertEqual(evaluate(DummyPath(), '[nan, true] and product all [true, false]'), all([False, False, True, False]))
        self.assertEqual(evaluate(DummyPath(), '[nan, true] product all and [1, nan, "s", ""]'), all([False, False, False, False, True, False, True, False]))
        self.assertEqual(evaluate(DummyPath(), '[nan, true] and product all [1, nan, "s", ""]'), all([False, False, False, False, True, False, True, False]))
        self.assertEqual(evaluate(DummyPath(), '[nan, true] product all and [1, "s", true]'), all([False, False, False, True, True, True]))
        self.assertEqual(evaluate(DummyPath(), '[nan, true] and product all [1, "s", true]'), all([False, False, False, True, True, True]))
        self.assertEqual(evaluate(DummyPath(), '[nan, true] product all and [0, nan, ""]'), all([False, False, False, False, False, False]))
        self.assertEqual(evaluate(DummyPath(), '[nan, true] and product all [0, nan, ""]'), all([False, False, False, False, False, False]))
        # empty
        self.assertEqual(evaluate(DummyPath(), '[true, true] product all and []'), all([]))
        self.assertEqual(evaluate(DummyPath(), '[true, true] and product all []'), all([]))
