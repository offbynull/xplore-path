...
class EvaluatorTest(unittest.TestCase):
    def test_must_be_greater_than_or_equal_single_vs_single(self):
        ...
        self.assertEqual(evaluate(DummyPath(), '"5">=5.0'), True)
        self.assertEqual(evaluate(DummyPath(), '"5">="5"'), True)
        self.assertEqual(evaluate(DummyPath(), '5>=4'), True)
        self.assertEqual(evaluate(DummyPath(), '5>="4"'), True)
    ...
    def test_must_be_greater_than_or_equal_single_vs_seq_using_product_sequence(self):
        ...
        self.assertEqual(evaluate(DummyPath(), '5 product sequence >= (x, 1)'), [False, True])
    ...
    def test_must_be_greater_than_or_equal_seq_vs_seq_using_zip_sequence(self):
        self.assertEqual(evaluate(DummyPath(), '(5,6,7) zip sequence >= (5,5)'), [True, True])
        self.assertEqual(evaluate(DummyPath(), '(5,5) zip sequence >= (5,6,7)'), [True, False])
        self.assertEqual(evaluate(DummyPath(), '(5.0,"6",7) zip sequence >= (5,5)'), [True, True])
        ...
        self.assertEqual(evaluate(DummyPath(), '(x,6) zip sequence >= (5,5)'), [False, True])
    ...
    def test_must_be_greater_than_or_equal_seq_vs_seq_using_zip_all(self):
        self.assertEqual(evaluate(DummyPath(), '(5,6,7) zip all >= (5,5)'), True)
        self.assertEqual(evaluate(DummyPath(), '(5,5) zip all >= (5,6,7)'), False)
        self.assertEqual(evaluate(DummyPath(), '(5.0,"6",7) zip all >= (5,5)'), True)
        self.assertEqual(evaluate(DummyPath(), '(5,5) zip all >= (5.0,"6",7)'), False)
        self.assertEqual(evaluate(DummyPath(), '(5,5) zip all >= (x,6)'), False)
        self.assertEqual(evaluate(DummyPath(), '(x,6) zip all >= (5,5)'), False)
